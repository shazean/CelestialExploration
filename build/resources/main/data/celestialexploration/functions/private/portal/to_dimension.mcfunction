...
execute as @e[type=area_effect_cloud,tag=portal_checker,limit=1] at @s run function celestialexploration:dimension_list

execute as @e[type=area_effect_cloud,tag=portal_checker] at @s run function celestialexploration:private/portal/find_parent