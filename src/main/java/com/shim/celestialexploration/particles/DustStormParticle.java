...
public class DustStormParticle extends TextureSheetParticle {
    protected DustStormParticle(ClientLevel p_108484_, double p_108485_, double p_108486_, double p_108487_) {
        super(p_108484_, p_108485_, p_108486_, p_108487_, 0.0D, 0.0D, 0.0D);
        this.xd *= 3.7F; //0.3F;
        this.yd = Math.random() * (double) 0.2F + (double) 0.15F;
        this.zd *= 3.7F; //0.3F;
        this.setSize(0.01F, 0.01F);
        this.gravity = 0.01F; //0.06F
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_108503_, ClientLevel p_108504_, double p_108505_, double p_108506_, double p_108507_, double p_108508_, double p_108509_, double p_108510_) {
            DustStormParticle dustStormParticle = new DustStormParticle(p_108504_, p_108505_, p_108506_, p_108507_);
            dustStormParticle.pickSprite(this.sprite);
            return dustStormParticle;
        }
    }
}