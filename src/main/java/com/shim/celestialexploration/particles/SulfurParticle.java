...
public class SulfurParticle extends TextureSheetParticle {
    SulfurParticle(ClientLevel p_107074_, double p_107075_, double p_107076_, double p_107077_) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_107103_, ClientLevel p_107104_, double p_107105_, double p_107106_, double p_107107_, double p_107108_, double p_107109_, double p_107110_) {
            SulfurParticle particle = new SulfurParticle(p_107104_, p_107105_, p_107106_, p_107107_);
