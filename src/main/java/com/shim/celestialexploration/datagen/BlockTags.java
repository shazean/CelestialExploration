...
public class BlockTags extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        tag(net.minecraft.tags.BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                //IO
                .addTag(TagRegistry.Blocks.IO_STONE)
                .addTag(TagRegistry.Blocks.IO_COBBLESTONE)
                .addTag(TagRegistry.Blocks.IO_DEEPSLATE)
                .addTag(TagRegistry.Blocks.IO_COBBLED_DEEPSLATE)
                .add(BlockRegistry.IO_SULFUR_ORE.get()).add(BlockRegistry.IO_DEEPSLATE_IRON_ORE.get())
        ...
        tag(net.minecraft.tags.BlockTags.NEEDS_STONE_TOOL)
                ...
                .add(BlockRegistry.IO_DEEPSLATE_IRON_ORE.get())
        ...
        tag(net.minecraft.tags.BlockTags.NEEDS_IRON_TOOL)
                ...
                .add(BlockRegistry.IO_SULFUR_ORE.get())
        ...
        tag(net.minecraft.tags.BlockTags.MINEABLE_WITH_SHOVEL)
                ...
                .add(BlockRegistry.MOON_SAND_PATH.get()).add(BlockRegistry.MARS_SAND_PATH.get())
                ...
                .add(BlockRegistry.VENUS_SAND_PATH.get()).add(BlockRegistry.MERCURY_SAND_PATH.get())
                .add(BlockRegistry.MERCURY_SAND.get()).add(BlockRegistry.COARSE_MERCURY_SAND.get())
                .add(BlockRegistry.GLOWING_CALLISTO_SAND.get()).add(BlockRegistry.GLOWING_EUROPA_SAND.get())
                .add(BlockRegistry.GLOWING_GANYMEDE_SAND.get())
                .add(BlockRegistry.IO_SAND.get()).add(BlockRegistry.COARSE_IO_SAND.get())
                .add(BlockRegistry.GLOWING_IO_SAND.get()).add(BlockRegistry.IO_SAND_PATH.get());
        ...
        tag(net.minecraft.tags.BlockTags.SAND)
                ...
                .add(BlockRegistry.GLOWING_GANYMEDE_SAND.get())
                .add(BlockRegistry.IO_SAND.get()).add(BlockRegistry.GLOWING_IO_SAND.get());
        ...
        tag(net.minecraft.tags.BlockTags.SLABS)
                ...
                .add(BlockRegistry.IO_STONE_SLAB.get()).add(BlockRegistry.IO_SMOOTH_STONE_SLAB.get()).add(BlockRegistry.IO_BRICK_SLAB.get())
                .add(BlockRegistry.IO_COBBLESTONE_SLAB.get()).add(BlockRegistry.IO_COBBLED_DEEPSLATE_SLAB.get())
                .add(BlockRegistry.IO_DEEPSLATE_BRICK_SLAB.get()).add(BlockRegistry.IO_DEEPSLATE_TILE_SLAB.get()).add(BlockRegistry.IO_POLISHED_DEEPSLATE_SLAB.get())

                .add(BlockRegistry.EUROPA_BRICK_SLAB.get())
                .add(BlockRegistry.CALLISTO_BRICK_SLAB.get())
                .add(BlockRegistry.GANYMEDE_BRICK_SLAB.get())
        ...
        tag(net.minecraft.tags.BlockTags.STAIRS)
                ...
                .add(BlockRegistry.IO_STONE_STAIRS.get()).add(BlockRegistry.IO_BRICK_STAIRS.get())
                .add(BlockRegistry.IO_COBBLESTONE_STAIRS.get()).add(BlockRegistry.IO_COBBLED_DEEPSLATE_STAIRS.get())
                .add(BlockRegistry.IO_DEEPSLATE_BRICK_STAIRS.get()).add(BlockRegistry.IO_DEEPSLATE_TILE_STAIRS.get()).add(BlockRegistry.IO_POLISHED_DEEPSLATE_STAIRS.get())

                .add(BlockRegistry.EUROPA_BRICK_STAIRS.get())
                .add(BlockRegistry.CALLISTO_BRICK_STAIRS.get())
                .add(BlockRegistry.GANYMEDE_BRICK_STAIRS.get())
        ...
        tag(net.minecraft.tags.BlockTags.WALLS)
                ...
                .add(BlockRegistry.IO_BRICK_WALL.get())
                .add(BlockRegistry.IO_COBBLESTONE_WALL.get()).add(BlockRegistry.IO_COBBLED_DEEPSLATE_WALL.get())
                .add(BlockRegistry.IO_DEEPSLATE_BRICK_WALL.get()).add(BlockRegistry.IO_DEEPSLATE_TILE_WALL.get()).add(BlockRegistry.IO_POLISHED_DEEPSLATE_WALL.get())

                .add(BlockRegistry.EUROPA_BRICK_WALL.get())
                .add(BlockRegistry.CALLISTO_BRICK_WALL.get())
                .add(BlockRegistry.GANYMEDE_BRICK_WALL.get())
        ...
        tag(net.minecraft.tags.BlockTags.BUTTONS)
                ...
                .add(BlockRegistry.IO_STONE_BUTTON.get()).add(BlockRegistry.IO_DEEPSLATE_BUTTON.get())
        ...
        tag(net.minecraft.tags.BlockTags.PRESSURE_PLATES)
                ...
                .add(BlockRegistry.IO_STONE_PRESSURE_PLATE.get()).add(BlockRegistry.IO_DEEPSLATE_PRESSURE_PLATE.get())
        ...
        tag(net.minecraft.tags.BlockTags.SOUL_FIRE_BASE_BLOCKS)
                ...
                .add(BlockRegistry.IO_SAND.get()).add(BlockRegistry.COARSE_IO_SAND.get())
                .add(BlockRegistry.IO_STONE.get()).add(BlockRegistry.IO_DEEPSLATE.get())
                .add(BlockRegistry.IO_COBBLESTONE.get()).add(BlockRegistry.IO_COBBLED_DEEPSLATE.get())
                .add(BlockRegistry.IO_GEYSER.get());
        ...
        tag(net.minecraft.tags.BlockTags.PORTALS)
                ...
                .add(BlockRegistry.CALLISTO_PORTAL.get()).add(BlockRegistry.IO_PORTAL.get())
        ;
        ...
        tag(Tags.Blocks.GLASS)
                ...
                .add(BlockRegistry.LUMINOUS_BLUE_GLASS.get()).add(BlockRegistry.LUMINOUS_CYAN_GLASS.get())
                .add(BlockRegistry.LUMINOUS_MAGENTA_GLASS.get()).add(BlockRegistry.LUMINOUS_RED_GLASS.get())
                .add(BlockRegistry.LUMINOUS_YELLOW_GLASS.get()).add(BlockRegistry.LUMINOUS_WHITE_GLASS.get());
        ...
        tag(Tags.Blocks.GLASS_PANES)
                ...
                .add(BlockRegistry.LUMINOUS_MAGENTA_GLASS_PANE.get()).add(BlockRegistry.LUMINOUS_RED_GLASS_PANE.get())
                .add(BlockRegistry.LUMINOUS_YELLOW_GLASS_PANE.get()).add(BlockRegistry.LUMINOUS_WHITE_GLASS_PANE.get());
        ...
        //---- IO -------------------------------------------------------------------------------
        tag(TagRegistry.Blocks.IO_STONE)
                .add(BlockRegistry.IO_STONE.get()).add(BlockRegistry.IO_STONE_SLAB.get()).add(BlockRegistry.IO_STONE_STAIRS.get())
                .add(BlockRegistry.IO_SMOOTH_STONE.get()).add(BlockRegistry.IO_SMOOTH_STONE_SLAB.get())
                .add(BlockRegistry.IO_BRICKS.get()).add(BlockRegistry.IO_BRICK_SLAB.get()).add(BlockRegistry.IO_BRICK_STAIRS.get()).add(BlockRegistry.IO_BRICK_WALL.get())
                .add(BlockRegistry.CHISELED_IO_BRICKS.get()).add(BlockRegistry.IO_BRICK_PILLAR.get()).add(BlockRegistry.CRACKED_IO_BRICKS.get());

        tag(TagRegistry.Blocks.IO_COBBLESTONE)
                .add(BlockRegistry.IO_COBBLESTONE.get()).add(BlockRegistry.IO_COBBLESTONE_SLAB.get())
                .add(BlockRegistry.IO_COBBLESTONE_STAIRS.get()).add(BlockRegistry.IO_COBBLESTONE_WALL.get());

        tag(TagRegistry.Blocks.IO_DEEPSLATE)
                .add(BlockRegistry.IO_DEEPSLATE.get()).add(BlockRegistry.CRACKED_IO_DEEPSLATE_BRICKS.get()).add(BlockRegistry.CRACKED_IO_DEEPSLATE_TILES.get()).add(BlockRegistry.CHISELED_IO_DEEPSLATE_BRICKS.get())
                .add(BlockRegistry.IO_DEEPSLATE_BRICKS.get()).add(BlockRegistry.IO_DEEPSLATE_BRICK_SLAB.get()).add(BlockRegistry.IO_DEEPSLATE_BRICK_STAIRS.get()).add(BlockRegistry.IO_DEEPSLATE_BRICK_WALL.get())
                .add(BlockRegistry.IO_DEEPSLATE_TILES.get()).add(BlockRegistry.IO_DEEPSLATE_TILE_SLAB.get()).add(BlockRegistry.IO_DEEPSLATE_TILE_STAIRS.get()).add(BlockRegistry.IO_DEEPSLATE_TILE_WALL.get())
                .add(BlockRegistry.IO_POLISHED_DEEPSLATE.get()).add(BlockRegistry.IO_POLISHED_DEEPSLATE_SLAB.get()).add(BlockRegistry.IO_POLISHED_DEEPSLATE_STAIRS.get()).add(BlockRegistry.IO_POLISHED_DEEPSLATE_WALL.get());

        tag(TagRegistry.Blocks.IO_COBBLED_DEEPSLATE)
                .add(BlockRegistry.IO_COBBLED_DEEPSLATE.get()).add(BlockRegistry.IO_COBBLED_DEEPSLATE_SLAB.get())
                .add(BlockRegistry.IO_COBBLED_DEEPSLATE_STAIRS.get()).add(BlockRegistry.IO_COBBLED_DEEPSLATE_WALL.get());
        ...
        tag(TagRegistry.Blocks.IO_PORTAL_FRAME_BLOCK)
                .add(BlockRegistry.IO_BRICKS.get());

        tag(TagRegistry.Blocks.GANYMEDE_PORTAL_FRAME_BLOCK)
                .add(BlockRegistry.GANYMEDE_BRICKS.get());
        ...
        tag(TagRegistry.Blocks.COMPRESSIBLE)
                ...
                .add(BlockRegistry.IO_COBBLESTONE.get())
                .add(BlockRegistry.IO_COBBLED_DEEPSLATE.get())
                .add(BlockRegistry.COMPRESSED_IO_COBBLESTONE.get())
                .add(BlockRegistry.COMPRESSED_IO_COBBLED_DEEPSLATE.get());
