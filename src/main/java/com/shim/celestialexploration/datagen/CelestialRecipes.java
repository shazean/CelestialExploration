...
public class CelestialRecipes extends RecipeProvider {
	...
	public CelestialRecipes(DataGenerator generatorIn) {
		super(generatorIn);
	}
...
//		pane(BlockRegistry.PANEL.get(), BlockRegistry.THIN_PANEL.get(), BlockRegistry.PANEL.get(), consumer);
		...
		//---- MAG LEV -------------------------------------------------------------------------------
		ShapedRecipeBuilder.shaped(CelestialBlocks.MAG_RAIL.get(), 16).pattern("X X").pattern("X#X").pattern("X X").define('X', CelestialItems.STEEL_INGOT.get()).define('#', CelestialItems.STEEL_ROD.get()).unlockedBy("steel", has(CelestialItems.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(CelestialBlocks.POWERED_MAG_RAIL.get(), 6).pattern("X X").pattern("X#X").pattern("XRX").define('X', CelestialItems.STEEL_INGOT.get()).define('#', CelestialItems.STEEL_ROD.get()).define('R', Items.REDSTONE).unlockedBy("steel", has(CelestialItems.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(CelestialBlocks.DETECTOR_MAG_RAIL.get(), 6).pattern("X X").pattern("X#X").pattern("XRX").define('X', CelestialItems.STEEL_INGOT.get()).define('#', CelestialTags.Items.STONE_PRESSURE_PLATE).define('R', Items.REDSTONE).unlockedBy("steel", has(CelestialItems.STEEL_INGOT.get())).save(consumer);
