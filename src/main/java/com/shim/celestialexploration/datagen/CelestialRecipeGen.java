...
//		smeltingAndBlasting(BlockRegistry.MOON_DEEPSLATE_IRON_ORE.get(), Items.IRON_INGOT, 0.7F, 200, 100, BlockRegistry.MOON_DEEPSLATE_IRON_ORE.get(), consumer);
		...
		WorkbenchCraftingRecipeBuilder.shaped(CelestialBlocks.OXYGEN_COMPRESSOR.get(), CelestialFluids.MOLTEN_STEEL.get(), 0.333F, 1.4F)
				.pattern("GG")
				.pattern("RG")
				.define('G', Tags.Items.GLASS)
				.define('R', Items.REDSTONE).unlockedBy("has_iron", has(Items.IRON_INGOT)).save(consumer, saveName(CelestialBlocks.OXYGEN_COMPRESSOR.get(), "from_workbench"));

		WorkbenchCraftingRecipeBuilder.shaped(CelestialBlocks.OXYGEN_GENERATOR.get(), CelestialFluids.MOLTEN_ALUMINUM.get(), 0.333F, 1.4F)
				.pattern(" GG")
				.pattern(" GG")
				.pattern("RGG")
...
//		pane(BlockRegistry.PANEL.get(), BlockRegistry.THIN_PANEL.get(), BlockRegistry.PANEL.get(), consumer);
		...
		stoneTools(CelestialBlocks.MOON_COBBLESTONE.get(), Items.STICK, consumer);
		stoneTools(CelestialBlocks.MOON_COBBLESTONE.get(), CelestialItems.STONE_ROD.get(), consumer);
		stoneTools(CelestialBlocks.MARS_COBBLESTONE.get(), Items.STICK, consumer);
		stoneTools(CelestialBlocks.MARS_COBBLESTONE.get(), CelestialItems.STONE_ROD.get(), consumer);
		stoneTools(CelestialBlocks.VENUS_COBBLESTONE.get(), Items.STICK, consumer);
		stoneTools(CelestialBlocks.VENUS_COBBLESTONE.get(), CelestialItems.STONE_ROD.get(), consumer);
		stoneTools(CelestialBlocks.MERCURY_COBBLESTONE.get(), Items.STICK, consumer);
		...
		WorkbenchCraftingRecipeBuilder.shaped(CelestialItems.SIMPLE_SPACESUIT_BOOTS.get(), CelestialFluids.MOLTEN_IRON.get(), 0.222F, 1.4F).pattern("W W").pattern("W W").define('W', ItemTags.WOOL).unlockedBy("has_wool", has(Items.WHITE_WOOL)).save(consumer, saveName(CelestialItems.SIMPLE_SPACESUIT_BOOTS.get(), ""));

		WorkbenchCraftingRecipeBuilder.shaped(CelestialItems.LIGHTWEIGHT_SPACESUIT_HELMET.get(), CelestialFluids.MOLTEN_ALUMINUM.get(), 0.333F, 2.1F).pattern("WWW").pattern("WGW").define('W', ItemTags.WOOL).define('G', Tags.Items.GLASS).unlockedBy("has_wool", has(Items.WHITE_WOOL)).save(consumer, saveName(CelestialItems.SIMPLE_SPACESUIT_HELMET.get(), ""));
		WorkbenchCraftingRecipeBuilder.shaped(CelestialItems.LIGHTWEIGHT_SPACESUIT_CHESTPLATE.get(), CelestialFluids.MOLTEN_ALUMINUM.get(), 0.666F, 4.2F).pattern("W W").pattern("WWW").pattern("WWW").define('W', ItemTags.WOOL).unlockedBy("has_wool", has(Items.WHITE_WOOL)).save(consumer, saveName(CelestialItems.SIMPLE_SPACESUIT_CHESTPLATE.get(), ""));
		WorkbenchCraftingRecipeBuilder.shaped(CelestialItems.LIGHTWEIGHT_SPACESUIT_LEGGINGS.get(), CelestialFluids.MOLTEN_ALUMINUM.get(), 0.555F, 3.5F).pattern("WWW").pattern("W W").pattern("W W").define('W', ItemTags.WOOL).unlockedBy("has_wool", has(Items.WHITE_WOOL)).save(consumer, saveName(CelestialItems.SIMPLE_SPACESUIT_LEGGINGS.get(), ""));
		WorkbenchCraftingRecipeBuilder.shaped(CelestialItems.BUOYANT_SPACESUIT_BOOTS.get(), CelestialFluids.MOLTEN_ALUMINUM.get(), 0.222F, 1.4F).pattern("W W").pattern("I I").define('W', ItemTags.WOOL).define('I', CelestialBlocks.DRY_ICE.get()).unlockedBy("has_wool", has(Items.WHITE_WOOL)).save(consumer, saveName(CelestialItems.SIMPLE_SPACESUIT_BOOTS.get(), ""));

		WorkbenchCraftingRecipeBuilder.shaped(CelestialItems.HEAVY_DUTY_SPACESUIT_HELMET.get(), CelestialFluids.MOLTEN_STEEL.get(), 0.333F, 2.1F).pattern("WWW").pattern("AGA").define('W', ItemTags.WOOL).define('A', CelestialItems.COMPRESSED_AIR.get()).define('G', Tags.Items.GLASS).unlockedBy("has_wool", has(Items.WHITE_WOOL)).save(consumer, saveName(CelestialItems.SIMPLE_SPACESUIT_HELMET.get(), ""));
		WorkbenchCraftingRecipeBuilder.shaped(CelestialItems.HEAVY_DUTY_SPACESUIT_CHESTPLATE.get(), CelestialFluids.MOLTEN_STEEL.get(), 0.666F, 4.2F).pattern("D D").pattern("DDD").pattern("DDD").define('D', Items.DIAMOND).unlockedBy("has_wool", has(Items.WHITE_WOOL)).save(consumer, saveName(CelestialItems.SIMPLE_SPACESUIT_CHESTPLATE.get(), ""));
		WorkbenchCraftingRecipeBuilder.shaped(CelestialItems.HEAVY_DUTY_SPACESUIT_LEGGINGS.get(), CelestialFluids.MOLTEN_STEEL.get(), 0.555F, 3.5F).pattern("WWW").pattern("W W").pattern("W W").define('W', ItemTags.WOOL).unlockedBy("has_wool", has(Items.WHITE_WOOL)).save(consumer, saveName(CelestialItems.SIMPLE_SPACESUIT_LEGGINGS.get(), ""));
...
//		WorkbenchCraftingRecipeBuilder.shaped(BlockRegistry.ALUMINUM_BLOCK.get(), FluidRegistry.MOLTEN_ALUMINUM.get(), 1.0F, 0.0F).pattern("X").define('X', ItemRegistry.BLOCK_MOLD.get()).unlockedBy("has_aluminum", has(BlockRegistry.ALUMINUM_BLOCK.get())).save(consumer, "aluminum_block_from_molten_aluminum");
		...
		ShapedRecipeBuilder.shaped(Items.DIAMOND).pattern("XXX").pattern("XXX").pattern("XXX").define('X', CelestialItems.DIAMOND_SHARD.get()).unlockedBy("has_diamond_shard", has(CelestialItems.DIAMOND_SHARD.get())).save(consumer, "diamond_from_diamond_shard");

		//CONCRETE POWDER OPTIONS
		ShapelessRecipeBuilder.shapeless(Blocks.WHITE_CONCRETE_POWDER).requires(Items.WHITE_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "white_concrete_from_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.GRAY_CONCRETE_POWDER).requires(Items.GRAY_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "gray_concrete_from_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.LIGHT_GRAY_CONCRETE_POWDER).requires(Items.LIGHT_GRAY_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "light_gray_concrete_from_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.BLACK_CONCRETE_POWDER).requires(Items.BLACK_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "black_concrete_from_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.BROWN_CONCRETE_POWDER).requires(Items.BROWN_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "brown_concrete_from_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.PURPLE_CONCRETE_POWDER).requires(Items.PURPLE_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "purple_concrete_from_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.PINK_CONCRETE_POWDER).requires(Items.PINK_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "pink_concrete_from_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.MAGENTA_CONCRETE_POWDER).requires(Items.MAGENTA_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "magenta_concrete_from_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.LIGHT_BLUE_CONCRETE_POWDER).requires(Items.LIGHT_BLUE_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "light_blue_concrete_from_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.BLUE_CONCRETE_POWDER).requires(Items.BLUE_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "blue_concrete_from_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.CYAN_CONCRETE_POWDER).requires(Items.CYAN_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "cyan_concrete_from_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.GREEN_CONCRETE_POWDER).requires(Items.GREEN_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "green_concrete_from_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.LIME_CONCRETE_POWDER).requires(Items.LIME_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "lime_concrete_from_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.YELLOW_CONCRETE_POWDER).requires(Items.YELLOW_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "yellow_concrete_from_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.ORANGE_CONCRETE_POWDER).requires(Items.ORANGE_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "orange_concrete_from_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.RED_CONCRETE_POWDER).requires(Items.RED_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).requires(Blocks.GRAVEL).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "red_concrete_from_regolith");

		ShapelessRecipeBuilder.shapeless(Blocks.WHITE_CONCRETE_POWDER).requires(Items.WHITE_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "white_concrete_from_regolith_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.GRAY_CONCRETE_POWDER).requires(Items.GRAY_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "gray_concrete_from_regolith_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.LIGHT_GRAY_CONCRETE_POWDER).requires(Items.LIGHT_GRAY_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "light_gray_concrete_from_regolith_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.BLACK_CONCRETE_POWDER).requires(Items.BLACK_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "black_concrete_from_regolith_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.BROWN_CONCRETE_POWDER).requires(Items.BROWN_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "brown_concrete_from_regolith_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.PURPLE_CONCRETE_POWDER).requires(Items.PURPLE_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "purple_concrete_from_regolith_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.PINK_CONCRETE_POWDER).requires(Items.PINK_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "pink_concrete_from_regolith_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.MAGENTA_CONCRETE_POWDER).requires(Items.MAGENTA_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "magenta_concrete_from_regolith_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.LIGHT_BLUE_CONCRETE_POWDER).requires(Items.LIGHT_BLUE_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "light_blue_concrete_from_regolith_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.BLUE_CONCRETE_POWDER).requires(Items.BLUE_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "blue_concrete_from_regolith_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.CYAN_CONCRETE_POWDER).requires(Items.CYAN_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "cyan_concrete_from_regolith_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.GREEN_CONCRETE_POWDER).requires(Items.GREEN_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "green_concrete_from_regolith_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.LIME_CONCRETE_POWDER).requires(Items.LIME_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "lime_concrete_from_regolith_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.YELLOW_CONCRETE_POWDER).requires(Items.YELLOW_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "yellow_concrete_from_regolith_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.ORANGE_CONCRETE_POWDER).requires(Items.ORANGE_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "orange_concrete_from_regolith_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.RED_CONCRETE_POWDER).requires(Items.RED_DYE).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "red_concrete_from_regolith_coarse_regolith");

		ShapelessRecipeBuilder.shapeless(Blocks.WHITE_CONCRETE_POWDER).requires(Items.WHITE_DYE).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "white_concrete_from_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.GRAY_CONCRETE_POWDER).requires(Items.GRAY_DYE).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "gray_concrete_from_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.LIGHT_GRAY_CONCRETE_POWDER).requires(Items.LIGHT_GRAY_DYE).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "light_gray_concrete_from_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.BLACK_CONCRETE_POWDER).requires(Items.BLACK_DYE).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "black_concrete_from_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.BROWN_CONCRETE_POWDER).requires(Items.BROWN_DYE).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "brown_concrete_from_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.PURPLE_CONCRETE_POWDER).requires(Items.PURPLE_DYE).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "purple_concrete_from_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.PINK_CONCRETE_POWDER).requires(Items.PINK_DYE).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "pink_concrete_from_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.MAGENTA_CONCRETE_POWDER).requires(Items.MAGENTA_DYE).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "magenta_concrete_from_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.LIGHT_BLUE_CONCRETE_POWDER).requires(Items.LIGHT_BLUE_DYE).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "light_blue_concrete_from_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.BLUE_CONCRETE_POWDER).requires(Items.BLUE_DYE).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "blue_concrete_from_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.CYAN_CONCRETE_POWDER).requires(Items.CYAN_DYE).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "cyan_concrete_from_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.GREEN_CONCRETE_POWDER).requires(Items.GREEN_DYE).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "green_concrete_from_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.LIME_CONCRETE_POWDER).requires(Items.LIME_DYE).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "lime_concrete_from_coarse_regolith");
		ShapelessRecipeBuilder.shapeless(Blocks.YELLOW_CONCRETE_POWDER).requires(Items.YELLOW_DYE).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(Blocks.SAND).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).requires(CelestialTags.Items.COARSE_REGOLITH).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(consumer, "yellow_concrete_from_coarse_regolith");
	...
	private static void dyedItemWithLunarDust(ItemLike item, Consumer<FinishedRecipe> consumer) {
		...
		DyedRecipeBuilder.shaped(item, DyeColor.ORANGE).pattern("XD").define('X', item).define('D', CelestialItems.RHEA_DUST.get()).unlockedBy("has_" + name(item), has(item)).save(consumer, "orange_" + name(item));
		DyedRecipeBuilder.shaped(item, DyeColor.YELLOW).pattern("XD").define('X', item).define('D', CelestialItems.TITAN_DUST.get()).unlockedBy("has_" + name(item), has(item)).save(consumer, "yellow_" + name(item));
		DyedRecipeBuilder.shaped(item, DyeColor.LIME).pattern("XD").define('X', item).define('D', CelestialItems.IO_DUST.get()).unlockedBy("has_" + name(item), has(item)).save(consumer, "lime_" + name(item));
		DyedRecipeBuilder.shaped(item, DyeColor.GREEN).pattern("XD").define('X', item).define('D', CelestialItems.DIONE_DUST.get()).unlockedBy("has_" + name(item), has(item)).save(consumer, "green_" + name(item));
		DyedRecipeBuilder.shaped(item, DyeColor.CYAN).pattern("XD").define('X', item).define('D', CelestialItems.EUROPA_DUST.get()).unlockedBy("has_" + name(item), has(item)).save(consumer, "cyan_" + name(item));
		DyedRecipeBuilder.shaped(item, DyeColor.LIGHT_BLUE).pattern("XD").define('X', item).define('D', CelestialItems.ENCELADUS_DUST.get()).unlockedBy("has_" + name(item), has(item)).save(consumer, "light_blue_" + name(item));
		DyedRecipeBuilder.shaped(item, DyeColor.BLUE).pattern("XD").define('X', item).define('D', CelestialItems.MOON_DUST.get()).unlockedBy("has_" + name(item), has(item)).save(consumer, "blue_" + name(item));
		DyedRecipeBuilder.shaped(item, DyeColor.PURPLE).pattern("XD").define('X', item).define('D', CelestialItems.TRITON_DUST.get()).unlockedBy("has_" + name(item), has(item)).save(consumer, "purple_" + name(item));
		DyedRecipeBuilder.shaped(item, DyeColor.MAGENTA).pattern("XD").define('X', item).define('D', CelestialItems.CALLISTO_DUST.get()).unlockedBy("has_" + name(item), has(item)).save(consumer, "magenta_" + name(item));
	...
	protected static void stoneTools(ItemLike stone, ItemLike stick, Consumer<FinishedRecipe> consumer) {
		ShapedRecipeBuilder.shaped(Items.STONE_PICKAXE).pattern("XXX").pattern(" S ").pattern(" S ").define('X', stone).define('S', stick).unlockedBy(name(stone), has(stone)).save(consumer, "stone_pickaxe_from_" + name(stone) + "_and_" + name(stick));
		ShapedRecipeBuilder.shaped(Items.STONE_AXE).pattern("XX ").pattern("XS ").pattern(" S ").define('X', stone).define('S', stick).unlockedBy(name(stone), has(stone)).save(consumer, "stone_axe_from_" + name(stone) + "_and_" + name(stick));
		ShapedRecipeBuilder.shaped(Items.STONE_SHOVEL).pattern(" X ").pattern(" S ").pattern(" S ").define('X', stone).define('S', stick).unlockedBy(name(stone), has(stone)).save(consumer, "stone_shovel_from_" + name(stone) + "_and_" + name(stick));
		ShapedRecipeBuilder.shaped(Items.STONE_HOE).pattern("XX ").pattern(" S ").pattern(" S ").define('X', stone).define('S', stick).unlockedBy(name(stone), has(stone)).save(consumer, "stone_hoe_from_" + name(stone) + "_and_" + name(stick));
		ShapedRecipeBuilder.shaped(Items.STONE_SWORD).pattern(" X ").pattern(" X ").pattern(" S ").define('X', stone).define('S', stick).unlockedBy(name(stone), has(stone)).save(consumer, "stone_sword_from_" + name(stone) + "_and_" + name(stick));
	}
