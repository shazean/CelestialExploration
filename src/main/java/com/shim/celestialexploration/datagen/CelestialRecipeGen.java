...
//		pane(BlockRegistry.PANEL.get(), BlockRegistry.THIN_PANEL.get(), BlockRegistry.PANEL.get(), consumer);
		...
		WorkbenchCraftingRecipeBuilder.shaped(CelestialItems.LIGHTWEIGHT_SPACESUIT_HELMET.get(), CelestialFluids.MOLTEN_ALUMINUM.get(), 0.333F, 2.1F).pattern("WWW").pattern("WGW").define('W', ItemTags.WOOL).define('G', Tags.Items.GLASS).unlockedBy("has_wool", has(Items.WHITE_WOOL)).save(consumer, saveName(CelestialItems.LIGHTWEIGHT_SPACESUIT_HELMET.get(), ""));
		WorkbenchCraftingRecipeBuilder.shaped(CelestialItems.LIGHTWEIGHT_SPACESUIT_CHESTPLATE.get(), CelestialFluids.MOLTEN_ALUMINUM.get(), 0.666F, 4.2F).pattern("W W").pattern("WWW").pattern("WWW").define('W', ItemTags.WOOL).unlockedBy("has_wool", has(Items.WHITE_WOOL)).save(consumer, saveName(CelestialItems.LIGHTWEIGHT_SPACESUIT_CHESTPLATE.get(), ""));
		WorkbenchCraftingRecipeBuilder.shaped(CelestialItems.LIGHTWEIGHT_SPACESUIT_LEGGINGS.get(), CelestialFluids.MOLTEN_ALUMINUM.get(), 0.555F, 3.5F).pattern("WWW").pattern("W W").pattern("W W").define('W', ItemTags.WOOL).unlockedBy("has_wool", has(Items.WHITE_WOOL)).save(consumer, saveName(CelestialItems.LIGHTWEIGHT_SPACESUIT_LEGGINGS.get(), ""));
