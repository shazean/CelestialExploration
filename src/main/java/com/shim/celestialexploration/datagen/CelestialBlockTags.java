...
public class CelestialBlockTags extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        tag(CelestialTags.Blocks.COMPRESSIBLE)
                ...
                .add(CelestialBlocks.COMPRESSED_MOON_COBBLESTONE.get())
                ...
                .add(CelestialBlocks.COMPRESSED_MARS_COBBLESTONE.get())
                ...
                .add(CelestialBlocks.COMPRESSED_VENUS_COBBLESTONE.get())
