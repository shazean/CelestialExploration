...
//		add(FluidRegistry.MOLTEN_NETHERITE_BLOCK.get(), "Molten Copper");
		...
		add("advancements.celestial.plant_potato.title", "Best Botanist On This Planet");
		...
		add("advancements.celestial.enter_jupiter.title", "The Giant Gas Giant");
		add("advancements.celestial.enter_jupiter.description", "Reach Jupiter");
		add("advancements.celestial.enter_io.title", "Jupiter I");
		add("advancements.celestial.enter_io.description", "Reach Io");
		add("advancements.celestial.enter_europa.title", "Jupiter II");
		add("advancements.celestial.enter_europa.description", "Reach Europa");
		add("advancements.celestial.enter_callisto.title", "Jupiter IV");
		add("advancements.celestial.enter_callisto.description", "Reach Callisto");
		add("advancements.celestial.enter_ganymede.title", "Jupiter III");
		add("advancements.celestial.enter_ganymede.description", "Reach Ganymede");
