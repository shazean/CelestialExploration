...
public class Advancements extends AdvancementProvider {
    ...
    protected void registerAdvancements(Consumer<Advancement> consumer, ExistingFileHelper fileHelper) {
        ...
        Advancement enterEuropa = Advancement.Builder.advancement().display(new ItemStack(BlockRegistry.EUROPA_BRICKS.get()),
        ...
        Advancement enterIo = Advancement.Builder.advancement().display(new ItemStack(BlockRegistry.IO_BRICKS.get()),
                        ...
                        null, FrameType.TASK, true, true, false)
                .parent(enterMercury).addCriterion("entered_io", ChangeDimensionTrigger.TriggerInstance.changedDimensionTo(DimensionRegistry.IO)).save(consumer, modLoc("enter_io"));
