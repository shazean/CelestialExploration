...
public class Recipes extends RecipeProvider {
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.CHISELED_MOON_BRICKS.get()).pattern("X").pattern("X").define('X', BlockRegistry.MOON_BRICK_SLAB.get()).unlockedBy("moon_stone", has(BlockRegistry.MOON_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MOON_BRICK_PILLAR.get(), 4).pattern("X").pattern("X").define('X', BlockRegistry.MOON_BRICKS.get()).unlockedBy("moon_stone", has(BlockRegistry.MOON_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MOON_SMOOTH_STONE_SLAB.get(), 6).pattern("XXX").define('X', BlockRegistry.MOON_SMOOTH_STONE.get()).unlockedBy("has_moon_smooth_stone", has(BlockRegistry.MOON_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MOON_STONE_PRESSURE_PLATE.get()).pattern("XX").define('X', BlockRegistry.MOON_STONE.get()).unlockedBy("moon_stone", has(BlockRegistry.MOON_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MOON_DEEPSLATE_PRESSURE_PLATE.get()).pattern("XX").define('X', BlockRegistry.MOON_DEEPSLATE.get()).unlockedBy("moon_deepslate", has(BlockRegistry.MOON_DEEPSLATE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.CHISELED_MOON_DEEPSLATE_BRICKS.get()).pattern("X").pattern("X").define('X', BlockRegistry.MOON_COBBLED_DEEPSLATE_SLAB.get()).unlockedBy("has_moon_cobbled_deepslate", has(BlockRegistry.MOON_COBBLED_DEEPSLATE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.LUNAR_LANTERN.get()).pattern("XCX").pattern("C#C").pattern("XCX").define('X', BlockRegistry.MOON_STONE.get()).define('#', Items.IRON_INGOT).define('C', ItemRegistry.MOON_DUST.get()).unlockedBy("has_moon_dust", has(ItemRegistry.MOON_DUST.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.CHISELED_MARS_BRICKS.get()).pattern("X").pattern("X").define('X', BlockRegistry.MARS_BRICK_SLAB.get()).unlockedBy("mars_stone", has(BlockRegistry.MARS_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MARS_BRICK_PILLAR.get(), 4).pattern("X").pattern("X").define('X', BlockRegistry.MARS_BRICKS.get()).unlockedBy("mars_stone", has(BlockRegistry.MARS_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MARS_SMOOTH_STONE_SLAB.get(), 6).pattern("XXX").define('X', BlockRegistry.MARS_SMOOTH_STONE.get()).unlockedBy("has_mars_smooth_stone", has(BlockRegistry.MARS_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MARS_STONE_PRESSURE_PLATE.get()).pattern("XX").define('X', BlockRegistry.MARS_STONE.get()).unlockedBy("mars_stone", has(BlockRegistry.MARS_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MARS_DEEPSLATE_PRESSURE_PLATE.get()).pattern("XX").define('X', BlockRegistry.MARS_DEEPSLATE.get()).unlockedBy("mars_deepslate", has(BlockRegistry.MARS_DEEPSLATE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.CHISELED_MARS_DEEPSLATE_BRICKS.get()).pattern("X").pattern("X").define('X', BlockRegistry.MARS_COBBLED_DEEPSLATE_SLAB.get()).unlockedBy("has_mars_cobbled_deepslate", has(BlockRegistry.MARS_COBBLED_DEEPSLATE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MARS_LANTERN.get()).pattern("XCX").pattern("C#C").pattern("XCX").define('X', BlockRegistry.MARS_STONE.get()).define('C', Items.IRON_INGOT).define('#', Items.TORCH).unlockedBy("has_iron", has(Items.IRON_INGOT)).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.CHISELED_VENUS_BRICKS.get()).pattern("X").pattern("X").define('X', BlockRegistry.VENUS_BRICK_SLAB.get()).unlockedBy("venus_stone", has(BlockRegistry.VENUS_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.VENUS_BRICK_PILLAR.get(), 4).pattern("X").pattern("X").define('X', BlockRegistry.VENUS_BRICKS.get()).unlockedBy("venus_stone", has(BlockRegistry.VENUS_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.VENUS_SMOOTH_STONE_SLAB.get(), 6).pattern("XXX").define('X', BlockRegistry.VENUS_SMOOTH_STONE.get()).unlockedBy("has_venus_smooth_stone", has(BlockRegistry.VENUS_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.VENUS_STONE_PRESSURE_PLATE.get()).pattern("XX").define('X', BlockRegistry.VENUS_STONE.get()).unlockedBy("venus_stone", has(BlockRegistry.VENUS_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.VENUS_DEEPSLATE_PRESSURE_PLATE.get()).pattern("XX").define('X', BlockRegistry.VENUS_DEEPSLATE.get()).unlockedBy("venus_deepslate", has(BlockRegistry.VENUS_DEEPSLATE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.CHISELED_VENUS_DEEPSLATE_BRICKS.get()).pattern("X").pattern("X").define('X', BlockRegistry.VENUS_COBBLED_DEEPSLATE_SLAB.get()).unlockedBy("has_venus_cobbled_deepslate", has(BlockRegistry.VENUS_COBBLED_DEEPSLATE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.VENUS_LANTERN.get()).pattern("XCX").pattern("C#C").pattern("XCX").define('X', BlockRegistry.VENUS_STONE.get()).define('#', Items.IRON_INGOT).define('C', ItemRegistry.SULFUR_CRYSTAL.get()).unlockedBy("has_sulfur_crystal", has(ItemRegistry.SULFUR_CRYSTAL.get())).save(consumer);

		//---- METEOR -------------------------------------------------------------------------------
		ShapedRecipeBuilder.shaped(BlockRegistry.METEOR_BRICKS.get(), 4).pattern("XX").pattern("XX").define('X', BlockRegistry.METEOR.get()).unlockedBy("meteor", has(BlockRegistry.METEOR.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.METEOR_BRICK_SLAB.get(), 6).pattern("XXX").define('X', BlockRegistry.METEOR_BRICKS.get()).unlockedBy("meteor", has(BlockRegistry.METEOR.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.METEOR_BRICK_STAIRS.get(), 4).pattern("X  ").pattern("XX ").pattern("XXX").define('X', BlockRegistry.METEOR_BRICKS.get()).unlockedBy("meteor", has(BlockRegistry.METEOR.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.METEOR_BRICK_WALL.get(), 6).pattern("XXX").pattern("XXX").define('X', BlockRegistry.METEOR_BRICKS.get()).unlockedBy("meteor", has(BlockRegistry.METEOR.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.CHISELED_METEOR_BRICKS.get()).pattern("X").pattern("X").define('X', BlockRegistry.METEOR_BRICK_SLAB.get()).unlockedBy("meteor", has(BlockRegistry.METEOR.get())).save(consumer);
		...
		ShapelessRecipeBuilder.shapeless(BlockRegistry.METEOR_BUTTON.get()).requires(BlockRegistry.METEOR.get()).unlockedBy("meteor", has(BlockRegistry.METEOR.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.METEOR_PRESSURE_PLATE.get()).pattern("XX").define('X', BlockRegistry.METEOR.get()).unlockedBy("meteor", has(BlockRegistry.METEOR.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.CHISELED_MERCURY_BRICKS.get()).pattern("X").pattern("X").define('X', BlockRegistry.MERCURY_BRICK_SLAB.get()).unlockedBy("mercury_stone", has(BlockRegistry.MERCURY_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MERCURY_BRICK_PILLAR.get(), 4).pattern("X").pattern("X").define('X', BlockRegistry.MERCURY_BRICKS.get()).unlockedBy("mercury_stone", has(BlockRegistry.MERCURY_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MERCURY_SMOOTH_STONE_SLAB.get(), 6).pattern("XXX").define('X', BlockRegistry.MERCURY_SMOOTH_STONE.get()).unlockedBy("has_mercury_smooth_stone", has(BlockRegistry.MERCURY_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MERCURY_STONE_PRESSURE_PLATE.get()).pattern("XX").define('X', BlockRegistry.MERCURY_STONE.get()).unlockedBy("mercury_stone", has(BlockRegistry.MERCURY_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MERCURY_DEEPSLATE_PRESSURE_PLATE.get()).pattern("XX").define('X', BlockRegistry.MERCURY_DEEPSLATE.get()).unlockedBy("mercury_deepslate", has(BlockRegistry.MERCURY_DEEPSLATE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.CHISELED_MERCURY_DEEPSLATE_BRICKS.get()).pattern("X").pattern("X").define('X', BlockRegistry.MERCURY_COBBLED_DEEPSLATE_SLAB.get()).unlockedBy("has_mercury_cobbled_deepslate", has(BlockRegistry.MERCURY_COBBLED_DEEPSLATE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MERCURY_LANTERN.get()).pattern("XCX").pattern("C#C").pattern("XCX").define('X', ItemRegistry.CINNABAR.get()).define('C', Items.IRON_INGOT).define('#', Items.TORCH).unlockedBy("has_cinnabar", has(ItemRegistry.CINNABAR.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.CHISELED_JUPITER_DEEPSLATE_BRICKS.get()).pattern("X").pattern("X").define('X', BlockRegistry.JUPITER_COBBLED_DEEPSLATE_SLAB.get()).unlockedBy("has_jupiter_cobbled_deepslate", has(BlockRegistry.JUPITER_COBBLED_DEEPSLATE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.JUPITER_DEEPSLATE_PRESSURE_PLATE.get()).pattern("XX").define('X', BlockRegistry.JUPITER_DEEPSLATE.get()).unlockedBy("jupiter_deepslate", has(BlockRegistry.JUPITER_DEEPSLATE.get())).save(consumer);
		...
		ShapelessRecipeBuilder.shapeless(ItemRegistry.ALUMINUM_INGOT.get(), 3).requires(Items.IRON_INGOT).requires(ItemRegistry.BAUXITE_INGOT.get()).requires(ItemRegistry.BAUXITE_INGOT.get()).unlockedBy("has_raw_bauxite", has(ItemRegistry.RAW_BAUXITE.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.ALUMINUM_INGOT.get(), 3).requires(Items.COPPER_INGOT).requires(ItemRegistry.BAUXITE_INGOT.get()).requires(ItemRegistry.BAUXITE_INGOT.get()).unlockedBy("has_raw_bauxite", has(ItemRegistry.RAW_BAUXITE.get())).save(consumer, "aluminum_from_copper");
...
//		smeltingAndBlasting(BlockRegistry.METEOR_BAUXITE_ORE.get(), ItemRegistry.BAUXITE_INGOT.get(), 0.7F, 200, 100, BlockRegistry.BAUXITE_ORE.get(), consumer);
		...
		//STEEL
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.STEEL_INGOT.get(), 2, FluidRegistry.MOLTEN_IRON.get(), 0.1111F, 0.7F).pattern("X").define('X', Items.COAL).unlockedBy("has_iron", has(Items.IRON_INGOT)).save(consumer, "steel_ingot_from_workbench");
		...
		//ASSORTED
		ShapelessRecipeBuilder.shapeless(Items.IRON_NUGGET).requires(ItemRegistry.RUSTED_IRON_NUGGET.get()).unlockedBy("rusted_iron_nugget", has(ItemRegistry.RUSTED_IRON_NUGGET.get())).save(consumer, "iron_nugget_from_rusted_iron_nugget");
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(ItemRegistry.RUSTED_IRON_NUGGET.get()), Items.IRON_NUGGET, 1.0F, 30).unlockedBy("has_rusted_iron_nugget", has(ItemRegistry.RUSTED_IRON_NUGGET.get())).save(consumer, "smelting_rusted_iron_nugget");
		singleItem(ItemRegistry.CINNABAR.get(), Items.RED_DYE, 1, ItemRegistry.CINNABAR.get(), consumer);

		ShapelessRecipeBuilder.shapeless(ItemRegistry.STEEL_INGOT.get(), 2).requires(Items.COAL).requires(Items.IRON_INGOT).requires(Items.IRON_INGOT).unlockedBy("iron", has(Items.IRON_INGOT)).save(consumer, "steel_ingot_crafted");
		ShapedRecipeBuilder.shaped(ItemRegistry.STEEL_ROD.get(), 8).pattern("X").pattern("X").pattern("X").define('X', ItemRegistry.STEEL_INGOT.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(ItemRegistry.STEEL_WOOL.get(), 4).pattern(" X ").pattern("XSX").pattern(" X ").define('X', ItemRegistry.STEEL_NUGGET.get()).define('S', Items.STRING).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
...
//		smeltingAndBlasting(BlockRegistry.MOON_DEEPSLATE_IRON_ORE.get(), Items.IRON_INGOT, 0.7F, 200, 100, BlockRegistry.MOON_DEEPSLATE_IRON_ORE.get(), consumer);
		...
		//---- SPACESHIP -------------------------------------------------------------------------------
		ShapedRecipeBuilder.shaped(BlockRegistry.WORKBENCH.get()).pattern("XXX").pattern("X X").pattern("CCC").define('X', ItemTags.PLANKS).define('C', Blocks.COBBLESTONE).unlockedBy("has_cobblestone", has(Blocks.COBBLESTONE)).save(consumer);

		ShapedRecipeBuilder.shaped(ItemRegistry.LOX_TANK.get()).pattern("SsS").pattern("G G").pattern("SsS").define('S', ItemRegistry.STEEL_INGOT.get()).define('s', ItemRegistry.ALUMINUM_INGOT.get()).define('G', Tags.Items.GLASS).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.LOX_TANK.get(), 2, FluidRegistry.MOLTEN_STEEL.get(), 0.444F, 2.8F).pattern("AGA").pattern("G G").pattern("AGA").define('A', ItemRegistry.ALUMINUM_INGOT.get()).define('G', Tags.Items.GLASS).unlockedBy("has_iron", has(Items.IRON_INGOT)).save(consumer, "lox_tank_from_workbench");

		ShapedRecipeBuilder.shaped(BlockRegistry.OXYGEN_COMPRESSOR.get()).pattern("SSS").pattern("CGC").pattern("CRC").define('S', ItemRegistry.STEEL_INGOT.get()).define('C', ItemRegistry.ALUMINUM_INGOT.get()).define('G', Tags.Items.GLASS).define('R', Items.REDSTONE).unlockedBy("steel_ingot", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		...
		WorkbenchCraftingRecipeBuilder.shaped(BlockRegistry.STEEL_FRAME.get(), 4, FluidRegistry.MOLTEN_STEEL.get(), 0.222F, 1.4F).pattern("X").define('X', Items.SCAFFOLDING).unlockedBy("has_steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "steel_frame_from_workbench");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.SPACESHIP_FRAME.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.333F, 2.1F).pattern("C C").pattern(" X ").pattern("C C").define('X', BlockRegistry.STEEL_FRAME.get()).define('C', BlockRegistry.CERAMIC_TILE.get()).unlockedBy("has_steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "spaceship_frame_from_workbench");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.SPACESHIP_CABIN.get(), FluidRegistry.MOLTEN_ALUMINUM.get(), 0.444F, 2.8F).pattern(" C ").pattern("CGC").pattern("X X").define('C', BlockRegistry.CERAMIC_TILE.get()).define('G', Tags.Items.GLASS).define('X', Tags.Items.CHESTS).unlockedBy("has_steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "spaceship_cabin_from_workbench");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.SPACESHIP_ENGINE.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.555F, 3.1F).pattern("CRC").pattern("TTT").define('R', Items.REDSTONE).define('C', Items.COPPER_INGOT).define('T', Items.REDSTONE_TORCH).unlockedBy("has_steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "spaceship_engine_from_workbench");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.WHITE_SPACESHIP.get(), FluidRegistry.MOLTEN_ALUMINUM.get(), 0.333F, 1.7F).pattern("C").pattern("F").pattern("E").define('C', ItemRegistry.SPACESHIP_CABIN.get()).define('F', ItemRegistry.SPACESHIP_FRAME.get()).define('E', ItemRegistry.SPACESHIP_ENGINE.get()).unlockedBy("has_steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "spaceship_from_workbench");

		ShapelessRecipeBuilder.shapeless(ItemRegistry.BLACK_SPACESHIP.get()).requires(ItemRegistry.WHITE_SPACESHIP.get()).requires(Items.BLACK_DYE).unlockedBy("spaceship", has(ItemRegistry.WHITE_SPACESHIP.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.GREY_SPACESHIP.get()).requires(ItemRegistry.WHITE_SPACESHIP.get()).requires(Items.GRAY_DYE).unlockedBy("spaceship", has(ItemRegistry.WHITE_SPACESHIP.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.LIGHT_GREY_SPACESHIP.get()).requires(ItemRegistry.WHITE_SPACESHIP.get()).requires(Items.LIGHT_GRAY_DYE).unlockedBy("spaceship", has(ItemRegistry.WHITE_SPACESHIP.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.PINK_SPACESHIP.get()).requires(ItemRegistry.WHITE_SPACESHIP.get()).requires(Items.PINK_DYE).unlockedBy("spaceship", has(ItemRegistry.WHITE_SPACESHIP.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.RED_SPACESHIP.get()).requires(ItemRegistry.WHITE_SPACESHIP.get()).requires(Items.RED_DYE).unlockedBy("spaceship", has(ItemRegistry.WHITE_SPACESHIP.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.ORANGE_SPACESHIP.get()).requires(ItemRegistry.WHITE_SPACESHIP.get()).requires(Items.ORANGE_DYE).unlockedBy("spaceship", has(ItemRegistry.WHITE_SPACESHIP.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.YELLOW_SPACESHIP.get()).requires(ItemRegistry.WHITE_SPACESHIP.get()).requires(Items.YELLOW_DYE).unlockedBy("spaceship", has(ItemRegistry.WHITE_SPACESHIP.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.LIME_SPACESHIP.get()).requires(ItemRegistry.WHITE_SPACESHIP.get()).requires(Items.LIME_DYE).unlockedBy("spaceship", has(ItemRegistry.WHITE_SPACESHIP.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.GREEN_SPACESHIP.get()).requires(ItemRegistry.WHITE_SPACESHIP.get()).requires(Items.GREEN_DYE).unlockedBy("spaceship", has(ItemRegistry.WHITE_SPACESHIP.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.CYAN_SPACESHIP.get()).requires(ItemRegistry.WHITE_SPACESHIP.get()).requires(Items.CYAN_DYE).unlockedBy("spaceship", has(ItemRegistry.WHITE_SPACESHIP.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.BLUE_SPACESHIP.get()).requires(ItemRegistry.WHITE_SPACESHIP.get()).requires(Items.BLUE_DYE).unlockedBy("spaceship", has(ItemRegistry.WHITE_SPACESHIP.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.LIGHT_BLUE_SPACESHIP.get()).requires(ItemRegistry.WHITE_SPACESHIP.get()).requires(Items.LIGHT_BLUE_DYE).unlockedBy("spaceship", has(ItemRegistry.WHITE_SPACESHIP.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.PURPLE_SPACESHIP.get()).requires(ItemRegistry.WHITE_SPACESHIP.get()).requires(Items.PURPLE_DYE).unlockedBy("spaceship", has(ItemRegistry.WHITE_SPACESHIP.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.MAGENTA_SPACESHIP.get()).requires(ItemRegistry.WHITE_SPACESHIP.get()).requires(Items.MAGENTA_DYE).unlockedBy("spaceship", has(ItemRegistry.WHITE_SPACESHIP.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.BROWN_SPACESHIP.get()).requires(ItemRegistry.WHITE_SPACESHIP.get()).requires(Items.BROWN_DYE).unlockedBy("spaceship", has(ItemRegistry.WHITE_SPACESHIP.get())).save(consumer);

		//---- SPACE STATION -------------------------------------------------------------------------------
		ShapedRecipeBuilder.shaped(BlockRegistry.INSULATED_PANEL.get(), 4).pattern("XC").pattern("XC").define('X', ItemRegistry.ALUMINUM_INGOT.get()).define('C', BlockRegistry.WHITE_CERAMIC.get()).unlockedBy("aluminum", has(ItemRegistry.ALUMINUM_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.PATHWAY_LIGHT.get(), 4).pattern("XXX").pattern(" T ").define('X', ItemRegistry.ALUMINUM_INGOT.get()).define('T', Items.REDSTONE_TORCH).unlockedBy("aluminum", has(ItemRegistry.ALUMINUM_INGOT.get())).save(consumer);
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistry.INSULATED_PANEL.get()), BlockRegistry.INSULATED_PANEL_CORNER.get(), 1).unlockedBy("aluminum", has(ItemRegistry.ALUMINUM_INGOT.get())).save(consumer);
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistry.INSULATED_PANEL_CORNER.get()), BlockRegistry.INSULATED_PANEL.get(), 1).unlockedBy("aluminum", has(ItemRegistry.ALUMINUM_INGOT.get())).save(consumer, "insulated_panel_stonecutting");
		ShapedRecipeBuilder.shaped(BlockRegistry.PANEL.get()).pattern("XX").pattern("XX").define('X', ItemRegistry.ALUMINUM_INGOT.get()).unlockedBy("meteor", has(ItemRegistry.ALUMINUM_INGOT.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.THIN_PANEL.get()).pattern("XX").pattern("XX").define('X', BlockRegistry.PANEL.get()).unlockedBy("aluminum", has(ItemRegistry.ALUMINUM_INGOT.get())).save(consumer);

//		pane(BlockRegistry.PANEL.get(), BlockRegistry.THIN_PANEL.get(), BlockRegistry.PANEL.get(), consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.STEEL_LADDER.get()).pattern("X X").pattern("XXX").pattern("X X").define('X', ItemRegistry.STEEL_INGOT.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);

		ShapedRecipeBuilder.shaped(BlockRegistry.AIRLOCK_DOOR.get()).pattern("GX").pattern("DX").define('X', ItemRegistry.ALUMINUM_INGOT.get()).define('G', Tags.Items.GLASS_COLORLESS).define('D', BlockRegistry.STEEL_DOOR.get()).unlockedBy("aluminum", has(ItemRegistry.ALUMINUM_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.AIRLOCK_DOOR.get()).pattern("GX").pattern("DX").define('X', ItemRegistry.ALUMINUM_INGOT.get()).define('G', Tags.Items.GLASS_COLORLESS).define('D', Items.IRON_DOOR).unlockedBy("aluminum", has(ItemRegistry.ALUMINUM_INGOT.get())).save(consumer, "airlock_door_from_iron_door");

		ShapedRecipeBuilder.shaped(BlockRegistry.AIRLOCK_PANEL_DOOR.get(), 8).pattern("XX ").pattern("XXR").pattern("XX ").define('X', ItemRegistry.ALUMINUM_INGOT.get()).define('R', Items.REDSTONE).unlockedBy("aluminum", has(ItemRegistry.ALUMINUM_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.AIRLOCK_PANEL_DOOR_WINDOW.get(), 8).pattern("XX ").pattern("XGR").pattern("XX ").define('X', ItemRegistry.ALUMINUM_INGOT.get()).define('G', Tags.Items.GLASS).define('R', Items.REDSTONE).unlockedBy("aluminum", has(ItemRegistry.ALUMINUM_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.HANGAR_DOOR.get(), 8).pattern("XX ").pattern("XXR").pattern("XX ").define('X', ItemRegistry.STEEL_INGOT.get()).define('R', Items.REDSTONE).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.HANGAR_DOOR_WINDOW.get(), 8).pattern("XX ").pattern("XGR").pattern("XX ").define('X', ItemRegistry.STEEL_INGOT.get()).define('G', Tags.Items.GLASS).define('R', Items.REDSTONE).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);

		ShapedRecipeBuilder.shaped(BlockRegistry.AIRLOCK_TRAPDOOR.get(), 2).pattern("XGX").pattern("XXX").define('G', Tags.Items.GLASS_COLORLESS).define('X', ItemRegistry.ALUMINUM_INGOT.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);

		ShapedRecipeBuilder.shaped(BlockRegistry.STEEL_DOOR.get(), 3).pattern("XX").pattern("XX").pattern("XX").define('X', ItemRegistry.STEEL_INGOT.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.STEEL_TRAPDOOR.get(), 2).pattern("XXX").pattern("XXX").define('X', ItemRegistry.STEEL_INGOT.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.STEEL_BUTTON.get()).pattern("XX").pattern("XX").define('X', ItemRegistry.STEEL_NUGGET.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);

		ShapedRecipeBuilder.shaped(BlockRegistry.SOLAR_PANEL.get()).pattern("GGG").pattern("QQQ").pattern("SSS").define('G', Items.GLASS).define('Q', Items.QUARTZ_BLOCK).define('S', ItemRegistry.ALUMINUM_INGOT.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);

		ShapelessRecipeBuilder.shapeless(BlockRegistry.GLOW_STRIP.get()).requires(Items.TORCH).requires(Items.IRON_NUGGET).unlockedBy("torch", has(Items.TORCH)).save(consumer, "glow_strip_from_iron");
		ShapelessRecipeBuilder.shapeless(BlockRegistry.GLOW_STRIP.get()).requires(Items.TORCH).requires(ItemRegistry.STEEL_NUGGET.get()).unlockedBy("torch", has(Items.TORCH)).save(consumer, "glow_strip_from_steel");
		...
		//---- MAG LEV -------------------------------------------------------------------------------
		ShapedRecipeBuilder.shaped(BlockRegistry.MAG_RAIL.get(), 16).pattern("X X").pattern("X#X").pattern("X X").define('X', ItemRegistry.STEEL_INGOT.get()).define('#', ItemRegistry.STEEL_ROD.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.POWERED_MAG_RAIL.get(), 6).pattern("X X").pattern("X#X").pattern("XRX").define('X', ItemRegistry.STEEL_INGOT.get()).define('#', ItemRegistry.STEEL_ROD.get()).define('R', Items.REDSTONE).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.DETECTOR_MAG_RAIL.get(), 6).pattern("X X").pattern("X#X").pattern("XRX").define('X', ItemRegistry.STEEL_INGOT.get()).define('#', TagRegistry.Items.STONE_PRESSURE_PLATE).define('R', Items.REDSTONE).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.ACTIVATOR_MAG_RAIL.get(), 6).pattern("X#X").pattern("XRX").pattern("X#X").define('X', ItemRegistry.STEEL_INGOT.get()).define('#', ItemRegistry.STEEL_ROD.get()).define('R', Items.REDSTONE_TORCH).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(ItemRegistry.MAGCART.get()).pattern("X X").pattern("XXX").define('X', ItemRegistry.STEEL_INGOT.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(ItemRegistry.CHEST_MAGCART.get()).pattern("#").pattern("X").define('#', Tags.Items.CHESTS).define('X', ItemRegistry.MAGCART.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(ItemRegistry.CHEST_MAGCART.get()).pattern("X#X").pattern("XXX").define('#', Tags.Items.CHESTS).define('X', ItemRegistry.STEEL_INGOT.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "chest_magcart_from_steel_ingots");
		ShapedRecipeBuilder.shaped(ItemRegistry.FURNACE_MAGCART.get()).pattern("#").pattern("X").define('#', Items.FURNACE).define('X', ItemRegistry.MAGCART.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(ItemRegistry.FURNACE_MAGCART.get()).pattern("X#X").pattern("XXX").define('#', Items.FURNACE).define('X', ItemRegistry.STEEL_INGOT.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "furnace_magcart_from_steel_ingots");
		ShapedRecipeBuilder.shaped(ItemRegistry.HOPPER_MAGCART.get()).pattern("#").pattern("X").define('#', Items.HOPPER).define('X', ItemRegistry.MAGCART.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(ItemRegistry.HOPPER_MAGCART.get()).pattern("X#X").pattern("XXX").define('#', Items.HOPPER).define('X', ItemRegistry.STEEL_INGOT.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "hopper_magcart_from_steel_ingots");
		ShapedRecipeBuilder.shaped(ItemRegistry.TNT_MAGCART.get()).pattern("#").pattern("X").define('#', Items.TNT).define('X', ItemRegistry.MAGCART.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(ItemRegistry.TNT_MAGCART.get()).pattern("X#X").pattern("XXX").define('#', Items.TNT).define('X', ItemRegistry.STEEL_INGOT.get()).unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "tnt_magcart_from_steel_ingots");

		//---- ARMOR -------------------------------------------------------------------------------
		//STEEL
		ShapedRecipeBuilder.shaped(ItemRegistry.STEEL_HELMET.get()).pattern("XXX").pattern("X X").define('X', ItemRegistry.STEEL_INGOT.get()).unlockedBy("steel_ingot", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(ItemRegistry.STEEL_CHESTPLATE.get()).pattern("X X").pattern("XXX").pattern("XXX").define('X', ItemRegistry.STEEL_INGOT.get()).unlockedBy("steel_ingot", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(ItemRegistry.STEEL_LEGGINGS.get()).pattern("XXX").pattern("X X").pattern("X X").define('X', ItemRegistry.STEEL_INGOT.get()).unlockedBy("steel_ingot", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		ShapedRecipeBuilder.shaped(ItemRegistry.STEEL_BOOTS.get()).pattern("X X").pattern("X X").define('X', ItemRegistry.STEEL_INGOT.get()).unlockedBy("steel_ingot", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);

		//SPACE SUITS
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.BASIC_SPACESUIT_HELMET.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.333F, 2.1F).pattern("LLL").pattern("WGW").define('L', Items.LEATHER).define('W', ItemTags.WOOL).define('G', Tags.Items.GLASS).unlockedBy("has_leather", has(Items.LEATHER)).save(consumer, "basic_space_suit_helmet");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.BASIC_SPACESUIT_CHESTPLATE.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.666F, 4.2F).pattern("L L").pattern("WWW").pattern("LLL").define('W', ItemTags.WOOL).define('L', Items.LEATHER).unlockedBy("has_leather", has(Items.LEATHER)).save(consumer, "basic_space_suit_chestplate");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.BASIC_SPACESUIT_LEGGINGS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.555F, 3.5F).pattern("LLL").pattern("L L").pattern("W W").define('W', ItemTags.WOOL).define('L', Items.LEATHER).unlockedBy("has_leather", has(Items.LEATHER)).save(consumer, "basic_space_suit_leggings");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.BASIC_SPACESUIT_BOOTS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.222F, 1.4F).pattern("W W").pattern("L L").define('L', Items.LEATHER).define('W', ItemTags.WOOL).unlockedBy("has_leather", has(Items.LEATHER)).save(consumer, "basic_space_suit_boots");
		...
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.HEAVY_DUTY_SPACESUIT_LEGGINGS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.666F, 4.2F).pattern("LLL").pattern("D D").pattern("L L").define('L', Items.LEATHER).define('D', Tags.Items.GEMS_DIAMOND).unlockedBy("has_diamond", has(Items.DIAMOND)).save(consumer, "heavy_duty_space_suit_leggings");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.HEAVY_DUTY_SPACESUIT_BOOTS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.333F, 2.1F).pattern("R R").pattern("D D").define('D', Tags.Items.GEMS_DIAMOND).define('R', Items.RABBIT_HIDE).unlockedBy("has_diamond", has(Items.DIAMOND)).save(consumer, "heavy_duty_space_suit_boots");
		...
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.THERMAL_SPACESUIT_LEGGINGS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.666F, 4.2F).pattern("WWW").pattern("D D").pattern("W W").define('W', ItemTags.WOOL).define('D', Tags.Items.GEMS_DIAMOND).unlockedBy("has_diamond", has(Items.DIAMOND)).save(consumer, "thermal_space_suit_leggings");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.THERMAL_SPACESUIT_BOOTS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.333F, 2.1F).pattern("L L").pattern("D D").define('D', Tags.Items.GEMS_DIAMOND).define('L', Items.LEATHER).unlockedBy("has_diamond", has(Items.DIAMOND)).save(consumer, "thermal_space_suit_boots");
		...
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.ADVANCED_SPACESUIT_BOOTS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.333F, 2.1F).pattern("L L").pattern("O O").define('O', Items.OBSIDIAN).define('L', Items.LEATHER).unlockedBy("has_obsidian", has(Items.OBSIDIAN)).save(consumer, "advanced_space_suit_boots");
...
//		ShapedRecipeBuilder.shaped(ItemRegistry.INGOT_MOLD.get(), 8).pattern("XXX").pattern("XCX").pattern("XXX").define('C', Tags.Items.INGOTS).define('X', Tags.Items.COBBLESTONE).unlockedBy("has_iron_ingot", has(Items.IRON_INGOT)).save(consumer);
		...
		ShapedRecipeBuilder.shaped(ItemRegistry.FLUID_BASIN.get(), 1).pattern("XGX").pattern("X X").pattern(" X ").define('G', Tags.Items.GLASS).define('X', Tags.Items.INGOTS_IRON).unlockedBy("has_iron_ingot", has(Items.IRON_INGOT)).save(consumer);
		ShapedRecipeBuilder.shaped(ItemRegistry.FLUID_BASIN.get(), 1).pattern("XGX").pattern("X X").pattern(" X ").define('G', Tags.Items.GLASS).define('X', ItemRegistry.STEEL_INGOT.get()).unlockedBy("has_steel_ingot", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "fluid_basin_from_steel");
...
//		WorkbenchCraftingRecipeBuilder.shaped(BlockRegistry.ALUMINUM_BLOCK.get(), FluidRegistry.MOLTEN_ALUMINUM.get(), 1.0F, 0.0F).pattern("X").define('X', ItemRegistry.BLOCK_MOLD.get()).unlockedBy("has_aluminum", has(BlockRegistry.ALUMINUM_BLOCK.get())).save(consumer, "aluminum_block_from_molten_aluminum");
		...
		//---- GLASS/CERAMICS -------------------------------------------------------------------------------
		//GLASS
		ShapelessRecipeBuilder.shapeless(BlockRegistry.LUMINOUS_BLUE_GLASS.get()).requires(Tags.Items.GLASS).requires(ItemRegistry.MOON_DUST.get()).unlockedBy("moon_dust", has(ItemRegistry.MOON_DUST.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(Items.GLASS, 8).pattern("GGG").pattern("GXG").pattern("GGG").define('X', ItemRegistry.STEEL_WOOL.get()).define('G', Tags.Items.STAINED_GLASS).unlockedBy("glass", has(Items.GLASS)).save(consumer, "glass_from_steel_wool");
		ShapedRecipeBuilder.shaped(Items.GLASS_PANE, 8).pattern("GGG").pattern("GXG").pattern("GGG").define('X', ItemRegistry.STEEL_WOOL.get()).define('G', Tags.Items.STAINED_GLASS_PANES).unlockedBy("glass", has(Items.GLASS)).save(consumer, "glass_pane_from_steel_wool");

		//CERAMIC
		WorkbenchCraftingRecipeBuilder.shaped(BlockRegistry.SILICA.get(), 4, Fluids.WATER, 0.25F, 0.0F).pattern("SS").pattern("SS").define('S', Tags.Items.SAND).unlockedBy("has_sand", has(Items.SAND)).save(consumer, "silica_from_workbench");
		smelting(BlockRegistry.SILICA.get(), BlockRegistry.CERAMIC.get(), 1.05F, 100, Blocks.SAND, consumer);

		ShapedRecipeBuilder.shaped(BlockRegistry.CERAMIC.get(), 8).pattern("GGG").pattern("GXG").pattern("GGG").define('X', ItemRegistry.STEEL_WOOL.get()).define('G', TagRegistry.Items.DYED_CERAMIC).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer, "ceramic_from_steel_wool");
		ShapedRecipeBuilder.shaped(BlockRegistry.CERAMIC_TILE.get(), 8).pattern("GGG").pattern("GXG").pattern("GGG").define('X', ItemRegistry.STEEL_WOOL.get()).define('G', TagRegistry.Items.DYED_CERAMIC_TILE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer, "ceramic_tile_from_steel_wool");

		ShapedRecipeBuilder.shaped(BlockRegistry.WHITE_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.WHITE_DYE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.LIGHT_GREY_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.LIGHT_GRAY_DYE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.GREY_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.GRAY_DYE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.BLACK_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.BLACK_DYE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.PURPLE_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.PURPLE_DYE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.MAGENTA_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.MAGENTA_DYE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.BLUE_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.BLUE_DYE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.LIGHT_BLUE_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.LIGHT_BLUE_DYE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.CYAN_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.CYAN_DYE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.GREEN_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.GREEN_DYE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.LIME_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.LIME_DYE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.YELLOW_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.YELLOW_DYE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.ORANGE_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.ORANGE_DYE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.BROWN_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.BROWN_DYE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.RED_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.RED_DYE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.PINK_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.PINK_DYE).unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		...
		//---- FOOD -------------------------------------------------------------------------------
		ShapedRecipeBuilder.shaped(ItemRegistry.MARSHMALLOW.get()).pattern("XX").pattern("XX").define('X', ItemRegistry.MARSHMALLOW_GOO.get()).unlockedBy("marshmallow_goo", has(ItemRegistry.MARSHMALLOW_GOO.get())).save(consumer, "marshmallow_from_marshmallow_goo");
		ShapelessRecipeBuilder.shapeless(ItemRegistry.MARSHMALLOW.get(), 2).requires(Items.SUGAR).requires(Items.MILK_BUCKET).requires(Items.SUGAR).requires(Items.SUGAR).unlockedBy("sugar", has(Items.SUGAR)).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.CHOCOLATE.get()).requires(Items.SUGAR).requires(Items.MILK_BUCKET).requires(Items.COCOA_BEANS).unlockedBy("cocoa_beans", has(Items.COCOA_BEANS)).save(consumer);
		ShapedRecipeBuilder.shaped(ItemRegistry.CRACKER.get(), 4).pattern("X").pattern("X").define('X', Items.WHEAT).unlockedBy("wheat", has(Items.WHEAT)).save(consumer);
		...
		ShapelessRecipeBuilder.shapeless(ItemRegistry.SMORES.get()).requires(ItemRegistry.ROASTED_MARSHMALLOW.get()).requires(ItemRegistry.CHOCOLATE.get()).requires(ItemRegistry.CRACKER.get()).requires(ItemRegistry.CRACKER.get()).unlockedBy("marshmallow_goo", has(ItemRegistry.MARSHMALLOW_GOO.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.LUNAR_CHEESE.get()).requires(ItemRegistry.LUNAR_GOO.get()).requires(Items.MILK_BUCKET).unlockedBy("lunar_goo", has(ItemRegistry.LUNAR_GOO.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.CHEESE.get()).requires(Items.MILK_BUCKET).requires(Items.MILK_BUCKET).unlockedBy("milk", has(Items.MILK_BUCKET)).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.SUSPICIOUS_JELLO.get()).requires(TagRegistry.Items.SLIME_DROPS).requires(Items.SUGAR).unlockedBy("slime_ball", has(Items.SLIME_BALL)).save(consumer);
		...
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.WHITE_MECHADOG.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.333F, 1.4F)
				...
				.pattern("FRF")
				.pattern("R R")
				.define('E', BlockRegistry.MECHADOG_HEAD.get())
				.define('F', BlockRegistry.STEEL_FRAME.get())
				.define('R', Items.REDSTONE).unlockedBy("has_head", has(BlockRegistry.MECHADOG_HEAD.get())).save(consumer, "white_mechadog");

		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.WHITE_MECHACERBERUS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.666F, 2.0F)
				.pattern("HHH")
				.pattern("FCF")
				.pattern("R R")
				.define('C', ItemRegistry.MECHADOG_CORE.get())
				.define('H', BlockRegistry.MECHADOG_HEAD.get())
				.define('F', BlockRegistry.STEEL_FRAME.get())
				.define('R', Items.REDSTONE).unlockedBy("has_core", has(ItemRegistry.MECHADOG_CORE.get())).save(consumer, "white_mechacerberus");
		...
		ShapelessRecipeBuilder.shapeless(ItemRegistry.BLACK_MECHACERBERUS.get()).requires(ItemRegistry.WHITE_MECHACERBERUS.get()).requires(Items.BLACK_DYE).unlockedBy("mechacerberus", has(ItemRegistry.WHITE_MECHACERBERUS.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.GREY_MECHACERBERUS.get()).requires(ItemRegistry.WHITE_MECHACERBERUS.get()).requires(Items.GRAY_DYE).unlockedBy("mechacerberus", has(ItemRegistry.WHITE_MECHACERBERUS.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.LIGHT_GREY_MECHACERBERUS.get()).requires(ItemRegistry.WHITE_MECHACERBERUS.get()).requires(Items.LIGHT_GRAY_DYE).unlockedBy("mechacerberus", has(ItemRegistry.WHITE_MECHACERBERUS.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.PINK_MECHACERBERUS.get()).requires(ItemRegistry.WHITE_MECHACERBERUS.get()).requires(Items.PINK_DYE).unlockedBy("mechacerberus", has(ItemRegistry.WHITE_MECHACERBERUS.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.RED_MECHACERBERUS.get()).requires(ItemRegistry.WHITE_MECHACERBERUS.get()).requires(Items.RED_DYE).unlockedBy("mechacerberus", has(ItemRegistry.WHITE_MECHACERBERUS.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.ORANGE_MECHACERBERUS.get()).requires(ItemRegistry.WHITE_MECHACERBERUS.get()).requires(Items.ORANGE_DYE).unlockedBy("mechacerberus", has(ItemRegistry.WHITE_MECHACERBERUS.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.YELLOW_MECHACERBERUS.get()).requires(ItemRegistry.WHITE_MECHACERBERUS.get()).requires(Items.YELLOW_DYE).unlockedBy("mechacerberus", has(ItemRegistry.WHITE_MECHACERBERUS.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.LIME_MECHACERBERUS.get()).requires(ItemRegistry.WHITE_MECHACERBERUS.get()).requires(Items.LIME_DYE).unlockedBy("mechacerberus", has(ItemRegistry.WHITE_MECHACERBERUS.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.GREEN_MECHACERBERUS.get()).requires(ItemRegistry.WHITE_MECHACERBERUS.get()).requires(Items.GREEN_DYE).unlockedBy("mechacerberus", has(ItemRegistry.WHITE_MECHACERBERUS.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.CYAN_MECHACERBERUS.get()).requires(ItemRegistry.WHITE_MECHACERBERUS.get()).requires(Items.CYAN_DYE).unlockedBy("mechacerberus", has(ItemRegistry.WHITE_MECHACERBERUS.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.BLUE_MECHACERBERUS.get()).requires(ItemRegistry.WHITE_MECHACERBERUS.get()).requires(Items.BLUE_DYE).unlockedBy("mechacerberus", has(ItemRegistry.WHITE_MECHACERBERUS.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.LIGHT_BLUE_MECHACERBERUS.get()).requires(ItemRegistry.WHITE_MECHACERBERUS.get()).requires(Items.LIGHT_BLUE_DYE).unlockedBy("mechacerberus", has(ItemRegistry.WHITE_MECHACERBERUS.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.PURPLE_MECHACERBERUS.get()).requires(ItemRegistry.WHITE_MECHACERBERUS.get()).requires(Items.PURPLE_DYE).unlockedBy("mechacerberus", has(ItemRegistry.WHITE_MECHACERBERUS.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.MAGENTA_MECHACERBERUS.get()).requires(ItemRegistry.WHITE_MECHACERBERUS.get()).requires(Items.MAGENTA_DYE).unlockedBy("mechacerberus", has(ItemRegistry.WHITE_MECHACERBERUS.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(ItemRegistry.BROWN_MECHACERBERUS.get()).requires(ItemRegistry.WHITE_MECHACERBERUS.get()).requires(Items.BROWN_DYE).unlockedBy("mechacerberus", has(ItemRegistry.WHITE_MECHACERBERUS.get())).save(consumer);
