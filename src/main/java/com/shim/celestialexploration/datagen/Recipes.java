...
public class Recipes extends RecipeProvider {
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.LUNAR_LANTERN.get()).pattern("XCX").pattern("C#C").pattern("XCX").define('X', BlockRegistry.MOON_STONE.get()).define('#', Items.IRON_INGOT).define('C', ItemRegistry.MOON_DUST.get()).group("celestialexploration").unlockedBy("has_moon_dust", has(ItemRegistry.MOON_DUST.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MARS_LANTERN.get()).pattern("XCX").pattern("C#C").pattern("XCX").define('X', BlockRegistry.MARS_STONE.get()).define('C', Items.IRON_INGOT).define('#', Items.TORCH).group("celestialexploration").unlockedBy("has_iron", has(Items.IRON_INGOT)).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.VENUS_LANTERN.get()).pattern("XCX").pattern("C#C").pattern("XCX").define('X', BlockRegistry.VENUS_STONE.get()).define('#', Items.IRON_INGOT).define('C', ItemRegistry.SULFUR_CRYSTAL.get()).group("celestialexploration").unlockedBy("has_sulfur_crystal", has(ItemRegistry.SULFUR_CRYSTAL.get())).save(consumer);

		//---- METEOR -------------------------------------------------------------------------------
		ShapedRecipeBuilder.shaped(BlockRegistry.METEOR_BRICKS.get(), 4).pattern("XX").pattern("XX").define('X', BlockRegistry.METEOR.get()).group("celestialexploration").unlockedBy("meteor", has(BlockRegistry.METEOR.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.METEOR_BRICK_SLAB.get(), 6).pattern("XXX").define('X', BlockRegistry.METEOR_BRICKS.get()).group("celestialexploration").unlockedBy("meteor", has(BlockRegistry.METEOR.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.METEOR_BRICK_STAIRS.get(), 4).pattern("X  ").pattern("XX ").pattern("XXX").define('X', BlockRegistry.METEOR_BRICKS.get()).group("celestialexploration").unlockedBy("meteor", has(BlockRegistry.METEOR.get())).save(consumer);
		...
		ShapelessRecipeBuilder.shapeless(BlockRegistry.METEOR_BUTTON.get()).requires(BlockRegistry.METEOR.get()).group("celestialexploration").unlockedBy("meteor", has(BlockRegistry.METEOR.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.CHISELED_MERCURY_BRICKS.get()).pattern("X").pattern("X").define('X', BlockRegistry.MERCURY_BRICK_SLAB.get()).group("celestialexploration").unlockedBy("mercury_stone", has(BlockRegistry.MERCURY_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MERCURY_BRICK_PILLAR.get(), 4).pattern("X").pattern("X").define('X', BlockRegistry.MERCURY_BRICKS.get()).group("celestialexploration").unlockedBy("mercury_stone", has(BlockRegistry.MERCURY_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MERCURY_SMOOTH_STONE_SLAB.get(), 6).pattern("XXX").define('X', BlockRegistry.MERCURY_SMOOTH_STONE.get()).group("celestialexploration").unlockedBy("has_mercury_smooth_stone", has(BlockRegistry.MERCURY_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MERCURY_STONE_PRESSURE_PLATE.get()).pattern("XX").define('X', BlockRegistry.MERCURY_STONE.get()).group("celestialexploration").unlockedBy("mercury_stone", has(BlockRegistry.MERCURY_STONE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.MERCURY_DEEPSLATE_PRESSURE_PLATE.get()).pattern("XX").define('X', BlockRegistry.MERCURY_DEEPSLATE.get()).group("celestialexploration").unlockedBy("mercury_deepslate", has(BlockRegistry.MERCURY_DEEPSLATE.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.CHISELED_MERCURY_DEEPSLATE_BRICKS.get()).pattern("X").pattern("X").define('X', BlockRegistry.MERCURY_COBBLED_DEEPSLATE_SLAB.get()).group("celestialexploration").unlockedBy("has_mercury_cobbled_deepslate", has(BlockRegistry.MERCURY_COBBLED_DEEPSLATE.get())).save(consumer);
...
//		smeltingAndBlasting(BlockRegistry.MOON_DEEPSLATE_IRON_ORE.get(), Items.IRON_INGOT, 0.7F, 200, 100, BlockRegistry.MOON_DEEPSLATE_IRON_ORE.get(), consumer);
		...
		WorkbenchCraftingRecipeBuilder.shaped(BlockRegistry.STEEL_FRAME.get(), 4, FluidRegistry.MOLTEN_STEEL.get(), 0.22F, 1.4F).pattern("X").define('X', Items.SCAFFOLDING).group("celestialexploration").unlockedBy("has_steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "steel_frame_from_workbench");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.SPACESHIP_FRAME.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.33F, 2.1F).pattern("C C").pattern(" X ").pattern("C C").define('X', BlockRegistry.STEEL_FRAME.get()).define('C', BlockRegistry.CERAMIC_TILE.get()).group("celestialexploration").unlockedBy("has_steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "spaceship_frame_from_workbench");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.SPACESHIP_CABIN.get(), FluidRegistry.MOLTEN_ALUMINUM.get(), 0.44F, 2.8F).pattern(" C ").pattern("CGC").pattern("X X").define('C', BlockRegistry.CERAMIC_TILE.get()).define('G', Tags.Items.GLASS).define('X', Tags.Items.CHESTS).group("celestialexploration").unlockedBy("has_steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "spaceship_cabin_from_workbench");
		...
		//---- SPACE STATION -------------------------------------------------------------------------------
		ShapedRecipeBuilder.shaped(BlockRegistry.INSULATED_PANEL.get(), 4).pattern("XC").pattern("XC").define('X', ItemRegistry.ALUMINUM_INGOT.get()).define('C', BlockRegistry.WHITE_CERAMIC.get()).group("celestialexploration").unlockedBy("aluminum", has(ItemRegistry.ALUMINUM_INGOT.get())).save(consumer);
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistry.INSULATED_PANEL.get()), BlockRegistry.INSULATED_PANEL_CORNER.get(), 1).group("celestialexploration").unlockedBy("aluminum", has(ItemRegistry.ALUMINUM_INGOT.get())).save(consumer);
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistry.INSULATED_PANEL_CORNER.get()), BlockRegistry.INSULATED_PANEL.get(), 1).group("celestialexploration").unlockedBy("aluminum", has(ItemRegistry.ALUMINUM_INGOT.get())).save(consumer, "insulated_panel_stonecutting");
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.DETECTOR_MAG_RAIL.get(), 6).pattern("X X").pattern("X#X").pattern("XRX").define('X', ItemRegistry.STEEL_INGOT.get()).define('#', TagRegistry.Items.STONE_PRESSURE_PLATE).define('R', Items.REDSTONE).group("celestialexploration").unlockedBy("steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer);
		...
		//SPACE SUITS
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.BASIC_SPACESUIT_HELMET.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.33F, 2.1F).pattern("LLL").pattern("WGW").define('L', Items.LEATHER).define('W', Items.WHITE_WOOL).define('G', Tags.Items.GLASS).group("celestialexploration").group("celestialexploration").unlockedBy("has_leather", has(Items.LEATHER)).save(consumer, "basic_space_suit_helmet");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.BASIC_SPACESUIT_CHESTPLATE.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.66F, 4.2F).pattern("L L").pattern("WWW").pattern("LLL").define('W', Items.WHITE_WOOL).define('L', Items.LEATHER).group("celestialexploration").unlockedBy("has_leather", has(Items.LEATHER)).save(consumer, "basic_space_suit_chestplate");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.BASIC_SPACESUIT_LEGGINGS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.55F, 3.5F).pattern("LLL").pattern("L L").pattern("W W").define('W', Items.WHITE_WOOL).define('L', Items.LEATHER).group("celestialexploration").unlockedBy("has_leather", has(Items.LEATHER)).save(consumer, "basic_space_suit_leggings");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.BASIC_SPACESUIT_BOOTS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.22F, 1.4F).pattern("W W").pattern("L L").define('L', Items.LEATHER).define('W', Items.WHITE_WOOL).group("celestialexploration").unlockedBy("has_leather", has(Items.LEATHER)).save(consumer, "basic_space_suit_boots");
		...
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.HEAVY_DUTY_SPACESUIT_LEGGINGS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.66F, 4.2F).pattern("LLL").pattern("D D").pattern("L L").define('L', Items.LEATHER).define('D', Tags.Items.GEMS_DIAMOND).group("celestialexploration").unlockedBy("has_diamond", has(Items.DIAMOND)).save(consumer, "heavy_duty_space_suit_leggings");
		...
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.THERMAL_SPACESUIT_LEGGINGS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.66F, 4.2F).pattern("WWW").pattern("D D").pattern("W W").define('W', Items.WHITE_WOOL).define('D', Tags.Items.GEMS_DIAMOND).group("celestialexploration").unlockedBy("has_diamond", has(Items.DIAMOND)).save(consumer, "thermal_space_suit_leggings");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.THERMAL_SPACESUIT_BOOTS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.33F, 2.1F).pattern("L L").pattern("D D").define('D', Tags.Items.GEMS_DIAMOND).define('L', Items.LEATHER).group("celestialexploration").unlockedBy("has_diamond", has(Items.DIAMOND)).save(consumer, "thermal_space_suit_boots");
		...
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.ADVANCED_SPACESUIT_BOOTS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.33F, 2.1F).pattern("L L").pattern("O O").define('O', Items.OBSIDIAN).define('L', Items.LEATHER).group("celestialexploration").unlockedBy("has_obsidian", has(Items.OBSIDIAN)).save(consumer, "advanced_space_suit_boots");
...
//		workbenchSmelting(FluidRegistry.MOLTEN_IRON.get(), BlockRegistry.MOON_DEEPSLATE_IRON_ORE.get(), 0.1F, 100, 0.1111F, BlockRegistry.MOON_DEEPSLATE_IRON_ORE.get(), consumer);
		...
		//REMOVAL
		WorkbenchCraftingRecipeBuilder.shaped(Items.WATER_BUCKET, Fluids.WATER, 1.0F, 0.0F).pattern("X").define('X', Items.BUCKET).group("celestialexploration").unlockedBy("has_iron", has(Items.IRON_INGOT)).save(consumer, "water_bucket_from_workbench");
		WorkbenchCraftingRecipeBuilder.shaped(Items.LAVA_BUCKET, Fluids.LAVA, 1.0F, 0.0F).pattern("X").define('X', Items.BUCKET).group("celestialexploration").unlockedBy("has_iron", has(Items.IRON_INGOT)).save(consumer, "lava_bucket_from_workbench");
		...
		WorkbenchCraftingRecipeBuilder.shaped(Items.IRON_INGOT, FluidRegistry.MOLTEN_IRON.get(), 0.1111F, 0.0F).pattern("X").define('X', ItemRegistry.INGOT_MOLD.get()).group("celestialexploration").unlockedBy("has_iron", has(Items.IRON_INGOT)).save(consumer, "iron_ingot_from_molten_iron");
		WorkbenchCraftingRecipeBuilder.shaped(Items.IRON_BLOCK, FluidRegistry.MOLTEN_IRON.get(), 1.0F, 0.0F).pattern("X").define('X', ItemRegistry.BLOCK_MOLD.get()).group("celestialexploration").unlockedBy("has_iron", has(Items.IRON_INGOT)).save(consumer, "iron_block_from_molten_iron");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.STEEL_INGOT.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.1111F, 0.0F).pattern("X").define('X', ItemRegistry.INGOT_MOLD.get()).group("celestialexploration").unlockedBy("has_steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "steel_ingot_from_molten_steel");
		WorkbenchCraftingRecipeBuilder.shaped(BlockRegistry.STEEL_BLOCK.get(), FluidRegistry.MOLTEN_STEEL.get(), 1.0F, 0.0F).pattern("X").define('X', ItemRegistry.BLOCK_MOLD.get()).group("celestialexploration").unlockedBy("has_steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "steel_block_from_molten_steel");
		WorkbenchCraftingRecipeBuilder.shaped(Items.COPPER_INGOT, FluidRegistry.MOLTEN_COPPER.get(), 0.11F, 0.0F).pattern("X").define('X', ItemRegistry.INGOT_MOLD.get()).group("celestialexploration").unlockedBy("has_copper", has(Items.COPPER_INGOT)).save(consumer, "copper_ingot_from_molten_copper");
		WorkbenchCraftingRecipeBuilder.shaped(Items.COPPER_BLOCK, FluidRegistry.MOLTEN_COPPER.get(), 1.0F, 0.0F).pattern("X").define('X', ItemRegistry.BLOCK_MOLD.get()).group("celestialexploration").unlockedBy("has_copper", has(Items.COPPER_INGOT)).save(consumer, "copper_block_from_molten_copper");
		WorkbenchCraftingRecipeBuilder.shaped(Items.GOLD_INGOT, FluidRegistry.MOLTEN_GOLD.get(), 0.1111F, 0.0F).pattern("X").define('X', ItemRegistry.INGOT_MOLD.get()).group("celestialexploration").unlockedBy("has_gold", has(Items.GOLD_INGOT)).save(consumer, "gold_ingot_from_molten_gold");
		WorkbenchCraftingRecipeBuilder.shaped(Items.GOLD_BLOCK, FluidRegistry.MOLTEN_GOLD.get(), 1.0F, 0.0F).pattern("X").define('X', ItemRegistry.BLOCK_MOLD.get()).group("celestialexploration").unlockedBy("has_gold", has(Items.GOLD_INGOT)).save(consumer, "gold_block_from_molten_gold");

		//---- GLASS/CERAMICS -------------------------------------------------------------------------------
		//GLASS
		ShapelessRecipeBuilder.shapeless(BlockRegistry.LUMINOUS_BLUE_GLASS.get()).requires(Tags.Items.GLASS).requires(ItemRegistry.MOON_DUST.get()).group("celestialexploration").unlockedBy("moon_dust", has(ItemRegistry.MOON_DUST.get())).save(consumer);
		ShapelessRecipeBuilder.shapeless(BlockRegistry.LUMINOUS_WHITE_GLASS.get()).requires(BlockRegistry.LUMINOUS_BLUE_GLASS.get()).requires(ItemRegistry.LUNAR_GOO.get()).group("celestialexploration").unlockedBy("moon_dust", has(ItemRegistry.MOON_DUST.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.LUMINOUS_BLUE_GLASS_PANE.get(), 16).pattern("XXX").pattern("XXX").define('X', BlockRegistry.LUMINOUS_BLUE_GLASS.get()).group("celestialexploration").unlockedBy("moon_dust", has(ItemRegistry.MOON_DUST.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.LUMINOUS_WHITE_GLASS_PANE.get(), 16).pattern("XXX").pattern("XXX").define('X', BlockRegistry.LUMINOUS_WHITE_GLASS.get()).group("celestialexploration").unlockedBy("moon_dust", has(ItemRegistry.MOON_DUST.get())).save(consumer);
		...
		ShapedRecipeBuilder.shaped(BlockRegistry.REINFORCED_GLASS_PANE.get(), 16).pattern("XXX").pattern("XXX").define('X', BlockRegistry.REINFORCED_GLASS.get()).group("celestialexploration").unlockedBy("glass", has(Blocks.GLASS)).save(consumer);
		...
		//CERAMIC
		WorkbenchCraftingRecipeBuilder.shaped(BlockRegistry.SILICA.get(), 4, Fluids.WATER, 0.25F, 0.0F).pattern("SS").pattern("SS").define('S', Tags.Items.SAND).group("celestialexploration").unlockedBy("has_sand", has(Items.SAND)).save(consumer, "silica_from_workbench");
		smelting(BlockRegistry.SILICA.get(), BlockRegistry.CERAMIC.get(), 1.05F, 100, Blocks.SAND, consumer);

		ShapedRecipeBuilder.shaped(BlockRegistry.CERAMIC.get(), 8).pattern("GGG").pattern("GXG").pattern("GGG").define('X', ItemRegistry.STEEL_WOOL.get()).define('G', TagRegistry.Items.DYED_CERAMIC).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer, "ceramic_from_steel_wool");
		ShapedRecipeBuilder.shaped(BlockRegistry.CERAMIC_TILE.get(), 8).pattern("GGG").pattern("GXG").pattern("GGG").define('X', ItemRegistry.STEEL_WOOL.get()).define('G', TagRegistry.Items.DYED_CERAMIC_TILE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer, "ceramic_tile_from_steel_wool");

		ShapedRecipeBuilder.shaped(BlockRegistry.WHITE_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.WHITE_DYE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.LIGHT_GREY_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.LIGHT_GRAY_DYE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.GREY_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.GRAY_DYE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.BLACK_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.BLACK_DYE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.PURPLE_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.PURPLE_DYE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.MAGENTA_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.MAGENTA_DYE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.BLUE_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.BLUE_DYE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.LIGHT_BLUE_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.LIGHT_BLUE_DYE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.CYAN_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.CYAN_DYE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.GREEN_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.GREEN_DYE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.LIME_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.LIME_DYE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.YELLOW_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.YELLOW_DYE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.ORANGE_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.ORANGE_DYE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.BROWN_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.BROWN_DYE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.RED_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.RED_DYE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
		ShapedRecipeBuilder.shaped(BlockRegistry.PINK_CERAMIC.get(), 8).pattern("XXX").pattern("X#X").pattern("XXX").define('X', BlockRegistry.CERAMIC.get()).define('#', Items.PINK_DYE).group("celestialexploration").unlockedBy("ceramic", has(BlockRegistry.CERAMIC.get())).save(consumer);
