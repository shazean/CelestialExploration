...
//		smeltingAndBlasting(BlockRegistry.MOON_DEEPSLATE_IRON_ORE.get(), Items.IRON_INGOT, 0.7F, 200, 100, BlockRegistry.MOON_DEEPSLATE_IRON_ORE.get(), consumer);
		...
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.SPACESHIP_FRAME.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.33F).pattern("C C").pattern(" X ").pattern("C C").define('X', BlockRegistry.STEEL_FRAME.get()).define('C', BlockRegistry.CERAMIC_TILE.get()).group("celestialexploration").unlockedBy("has_steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "spaceship_frame_from_workbench");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.SPACESHIP_CABIN.get(), FluidRegistry.MOLTEN_ALUMINUM.get(), 0.44F).pattern(" C ").pattern("CGC").pattern("X X").define('C', BlockRegistry.CERAMIC_TILE.get()).define('G', Tags.Items.GLASS).define('X', Tags.Items.CHESTS).group("celestialexploration").unlockedBy("has_steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "spaceship_cabin_from_workbench");
		...
		//SPACE SUITS
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.BASIC_SPACESUIT_HELMET.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.33F).pattern("LLL").pattern("WGW").define('L', Items.LEATHER).define('W', Items.WHITE_WOOL).define('G', Tags.Items.GLASS).group("celestialexploration").group("celestialexploration").unlockedBy("has_leather", has(Items.LEATHER)).save(consumer, "basic_space_suit_helmet");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.BASIC_SPACESUIT_CHESTPLATE.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.66F).pattern("L L").pattern("WWW").pattern("LLL").define('W', Items.WHITE_WOOL).define('L', Items.LEATHER).group("celestialexploration").unlockedBy("has_leather", has(Items.LEATHER)).save(consumer, "basic_space_suit_chestplate");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.BASIC_SPACESUIT_LEGGINGS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.55F).pattern("LLL").pattern("L L").pattern("W W").define('W', Items.WHITE_WOOL).define('L', Items.LEATHER).group("celestialexploration").unlockedBy("has_leather", has(Items.LEATHER)).save(consumer, "basic_space_suit_leggings");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.BASIC_SPACESUIT_BOOTS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.22F).pattern("W W").pattern("L L").define('L', Items.LEATHER).define('W', Items.WHITE_WOOL).group("celestialexploration").unlockedBy("has_leather", has(Items.LEATHER)).save(consumer, "basic_space_suit_boots");

		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.HEAVY_DUTY_SPACESUIT_HELMET.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.44F).pattern("DDD").pattern("LGL").define('L', Items.LEATHER).define('G', Tags.Items.GLASS).define('D', Tags.Items.GEMS_DIAMOND).group("celestialexploration").group("celestialexploration").unlockedBy("has_diamond", has(Items.DIAMOND)).save(consumer, "heavy_duty_space_suit_helmet");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.HEAVY_DUTY_SPACESUIT_CHESTPLATE.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.77F).pattern("L L").pattern("DDD").pattern("GMG").define('L', Items.LEATHER).define('G', Tags.Items.INGOTS_GOLD).define('D', Tags.Items.GEMS_DIAMOND).define('M', Items.MAGMA_CREAM).group("celestialexploration").unlockedBy("has_diamond", has(Items.DIAMOND)).save(consumer, "heavy_duty_space_suit_chestplate");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.HEAVY_DUTY_SPACESUIT_LEGGINGS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.66F).pattern("LLL").pattern("D D").pattern("L L").define('L', Items.LEATHER).define('D', Tags.Items.GEMS_DIAMOND).group("celestialexploration").unlockedBy("has_diamond", has(Items.DIAMOND)).save(consumer, "heavy_duty_space_suit_leggings");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.HEAVY_DUTY_SPACESUIT_BOOTS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.33F).pattern("R R").pattern("D D").define('D', Tags.Items.GEMS_DIAMOND).define('R', Items.RABBIT_HIDE).group("celestialexploration").unlockedBy("has_diamond", has(Items.DIAMOND)).save(consumer, "heavy_duty_space_suit_boots");

		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.THERMAL_SPACESUIT_HELMET.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.44F).pattern("DDD").pattern("WGW").define('W', Items.WHITE_WOOL).define('G', Tags.Items.GLASS).define('D', Tags.Items.GEMS_DIAMOND).group("celestialexploration").group("celestialexploration").unlockedBy("has_diamond", has(Items.DIAMOND)).save(consumer, "thermal_space_suit_helmet");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.THERMAL_SPACESUIT_CHESTPLATE.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.77F).pattern("L L").pattern("DDD").pattern("WWW").define('L', Items.LEATHER).define('D', Tags.Items.GEMS_DIAMOND).define('W', Items.WHITE_WOOL).group("celestialexploration").unlockedBy("has_diamond", has(Items.DIAMOND)).save(consumer, "thermal_space_suit_chestplate");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.THERMAL_SPACESUIT_LEGGINGS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.66F).pattern("WWW").pattern("D D").pattern("W W").define('W', Items.WHITE_WOOL).define('D', Tags.Items.GEMS_DIAMOND).group("celestialexploration").unlockedBy("has_diamond", has(Items.DIAMOND)).save(consumer, "thermal_space_suit_leggings");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.THERMAL_SPACESUIT_BOOTS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.33F).pattern("L L").pattern("D D").define('D', Tags.Items.GEMS_DIAMOND).define('L', Items.LEATHER).group("celestialexploration").unlockedBy("has_diamond", has(Items.DIAMOND)).save(consumer, "thermal_space_suit_boots");

		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.ADVANCED_SPACESUIT_HELMET.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.44F).pattern("OOO").pattern("DGD").define('O', Items.OBSIDIAN).define('G', Tags.Items.GLASS).define('D', Tags.Items.GEMS_DIAMOND).group("celestialexploration").group("celestialexploration").unlockedBy("has_obsidian", has(Items.OBSIDIAN)).save(consumer, "advanced_space_suit_helmet");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.ADVANCED_SPACESUIT_CHESTPLATE.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.77F).pattern("L L").pattern("DDD").pattern("OOO").define('L', Items.LEATHER).define('D', Tags.Items.GEMS_DIAMOND).define('O', Items.OBSIDIAN).group("celestialexploration").unlockedBy("has_obsidian", has(Items.OBSIDIAN)).save(consumer, "advanced_space_suit_chestplate");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.ADVANCED_SPACESUIT_LEGGINGS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.66F).pattern("DDD").pattern("O O").pattern("L L").define('O', Items.OBSIDIAN).define('L', Items.LEATHER).define('D', Tags.Items.GEMS_DIAMOND).group("celestialexploration").unlockedBy("has_obsidian", has(Items.OBSIDIAN)).save(consumer, "advanced_space_suit_leggings");
		WorkbenchCraftingRecipeBuilder.shaped(ItemRegistry.ADVANCED_SPACESUIT_BOOTS.get(), FluidRegistry.MOLTEN_STEEL.get(), 0.33F).pattern("L L").pattern("O O").define('O', Items.OBSIDIAN).define('L', Items.LEATHER).group("celestialexploration").unlockedBy("has_obsidian", has(Items.OBSIDIAN)).save(consumer, "advanced_space_suit_boots");
...
//		workbenchSmelting(FluidRegistry.MOLTEN_IRON.get(), BlockRegistry.MOON_DEEPSLATE_IRON_ORE.get(), 0.1F, 100, 0.1111F, BlockRegistry.MOON_DEEPSLATE_IRON_ORE.get(), consumer);
		...
		WorkbenchCraftingRecipeBuilder.shaped(BlockRegistry.STEEL_BLOCK.get(), FluidRegistry.MOLTEN_STEEL.get(), 1.0F).pattern("X").define('X', ItemRegistry.BLOCK_MOLD.get()).group("celestialexploration").unlockedBy("has_steel", has(ItemRegistry.STEEL_INGOT.get())).save(consumer, "steel_block_from_molten_steel");
		...
		//CERAMIC
		WorkbenchCraftingRecipeBuilder.shaped(BlockRegistry.SILICA.get(), 4, Fluids.WATER, 0.25F).pattern("SS").pattern("SS").define('S', Tags.Items.SAND).group("celestialexploration").unlockedBy("has_sand", has(Items.SAND)).save(consumer, "silica_from_workbench");
