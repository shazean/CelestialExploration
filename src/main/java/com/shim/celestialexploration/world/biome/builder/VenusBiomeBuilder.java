...
public class VenusBiomeBuilder {
...
//                this.addSurfaceBiome(p_187229_, climate$parameter, climate$parameter1, this.nearInlandContinentalness, this.erosions[5], p_187230_, 0.0F, resourcekey4);
    ...
    private void addValleys(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187238_, Climate.Parameter weirdness) {
        this.addSurfaceBiome(p_187238_, this.FROZEN_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), weirdness, 0.0F, CelestialBiomeKeys.SULFUR_RIVER);
        this.addSurfaceBiome(p_187238_, this.UNFROZEN_RANGE, this.humidities[0], this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), weirdness, 0.0F, CelestialBiomeKeys.SULFUR_RIVER);
        this.addSurfaceBiome(p_187238_, this.FROZEN_RANGE, this.humidities[0], this.nearInlandContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), weirdness, 0.0F, CelestialBiomeKeys.SULFUR_RIVER);
        this.addSurfaceBiome(p_187238_, this.UNFROZEN_RANGE, this.humidities[0], this.nearInlandContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), weirdness, 0.0F, CelestialBiomeKeys.SULFUR_RIVER);
        this.addSurfaceBiome(p_187238_, this.FROZEN_RANGE, this.humidities[0], Climate.Parameter.span(this.coastContinentalness, this.farInlandContinentalness), Climate.Parameter.span(this.erosions[2], this.erosions[5]), weirdness, 0.0F, CelestialBiomeKeys.SULFUR_RIVER);
        this.addSurfaceBiome(p_187238_, this.UNFROZEN_RANGE, this.humidities[0], Climate.Parameter.span(this.coastContinentalness, this.farInlandContinentalness), Climate.Parameter.span(this.erosions[2], this.erosions[5]), weirdness, 0.0F, CelestialBiomeKeys.SULFUR_RIVER);
        this.addSurfaceBiome(p_187238_, this.FROZEN_RANGE, this.humidities[0], this.coastContinentalness, this.erosions[6], weirdness, 0.0F, CelestialBiomeKeys.SULFUR_RIVER);
        this.addSurfaceBiome(p_187238_, this.UNFROZEN_RANGE, this.humidities[0], this.coastContinentalness, this.erosions[6], weirdness, 0.0F, CelestialBiomeKeys.SULFUR_RIVER);
        this.addSurfaceBiome(p_187238_, this.FROZEN_RANGE, this.humidities[0], Climate.Parameter.span(this.inlandContinentalness, this.farInlandContinentalness), this.erosions[6], weirdness, 0.0F, CelestialBiomeKeys.SULFUR_RIVER);
...
//        return CelestialBiomeKeys.VENUS_DRY_ICE_FLATS;
    }
