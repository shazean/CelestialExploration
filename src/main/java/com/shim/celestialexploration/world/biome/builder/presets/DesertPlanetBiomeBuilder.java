...
public class DesertPlanetBiomeBuilder {
    ...
    private final ResourceKey<Biome>[][] OCEANS = new ResourceKey[][]{
            {CelestialBiomeKeys.LOW_DESERT, CelestialBiomeKeys.LOW_DESERT, CelestialBiomeKeys.LOW_DESERT, CelestialBiomeKeys.LOW_DESERT, CelestialBiomeKeys.LOW_DESERT},
            {CelestialBiomeKeys.LOW_DESERT, CelestialBiomeKeys.LOW_DESERT, CelestialBiomeKeys.LOW_DESERT, CelestialBiomeKeys.LOW_DESERT, CelestialBiomeKeys.LOW_DESERT}};
    private final ResourceKey<Biome>[][] MIDDLE_BIOMES = new ResourceKey[][]{
            {CelestialBiomeKeys.ICY_DESERT, CelestialBiomeKeys.ICY_DESERT, CelestialBiomeKeys.ICY_DESERT, CelestialBiomeKeys.ICY_DESERT, CelestialBiomeKeys.ICY_DESERT},
            {Biomes.DESERT, Biomes.DESERT, Biomes.DESERT, Biomes.DESERT, Biomes.DESERT},
            {Biomes.DESERT, Biomes.DESERT, Biomes.DESERT, CelestialBiomeKeys.HIGH_DESERT, CelestialBiomeKeys.HIGH_DESERT},
            {CelestialBiomeKeys.HIGH_DESERT, CelestialBiomeKeys.HIGH_DESERT, CelestialBiomeKeys.HIGH_DESERT, CelestialBiomeKeys.MONSOON_DESERT, CelestialBiomeKeys.MONSOON_DESERT},
            {Biomes.DESERT, Biomes.DESERT, Biomes.DESERT, Biomes.DESERT, Biomes.DESERT}};
    private final ResourceKey<Biome>[][] MIDDLE_BIOMES_VARIANT = new ResourceKey[][]{
            {CelestialBiomeKeys.HIGH_DESERT, null, CelestialBiomeKeys.HIGH_DESERT, null, null},
            {null, null, null, null, CelestialBiomeKeys.HIGH_DESERT},
            {CelestialBiomeKeys.HIGH_DESERT, null, null, CelestialBiomeKeys.HIGH_DESERT, null},
            {null, null, CelestialBiomeKeys.HIGH_DESERT, CelestialBiomeKeys.MONSOON_DESERT, CelestialBiomeKeys.MONSOON_DESERT},
            {null, null, null, null, null}};
    private final ResourceKey<Biome>[][] PLATEAU_BIOMES = new ResourceKey[][]{
            {CelestialBiomeKeys.ICY_DESERT, CelestialBiomeKeys.ICY_DESERT, CelestialBiomeKeys.ICY_DESERT, CelestialBiomeKeys.ICY_DESERT, CelestialBiomeKeys.ICY_DESERT},
            {Biomes.DESERT, Biomes.DESERT, CelestialBiomeKeys.HIGH_DESERT, Biomes.DESERT, CelestialBiomeKeys.HIGH_DESERT},
            {CelestialBiomeKeys.HIGH_DESERT, CelestialBiomeKeys.HIGH_DESERT, CelestialBiomeKeys.HIGH_DESERT, Biomes.DESERT, Biomes.DESERT},
            {Biomes.DESERT, Biomes.DESERT, Biomes.DESERT, Biomes.DESERT, CelestialBiomeKeys.MONSOON_DESERT},
            {Biomes.DESERT, Biomes.DESERT, Biomes.DESERT, Biomes.DESERT, Biomes.DESERT}};
    private final ResourceKey<Biome>[][] PLATEAU_BIOMES_VARIANT = new ResourceKey[][]{
            {Biomes.ICE_SPIKES, null, null, null, null},
            {null, null, Biomes.DESERT, CelestialBiomeKeys.HIGH_DESERT, CelestialBiomeKeys.HIGH_DESERT},
            {null, null, Biomes.BADLANDS, Biomes.DESERT, null},
            {null, null, null, null, null},
            {Biomes.ERODED_BADLANDS, Biomes.ERODED_BADLANDS, null, null, null}};
    private final ResourceKey<Biome>[][] SHATTERED_BIOMES = new ResourceKey[][]{
            {null, null, null, null, null},
            {CelestialBiomeKeys.DUNES, CelestialBiomeKeys.DUNES, CelestialBiomeKeys.DUNES, CelestialBiomeKeys.DUNES, CelestialBiomeKeys.HIGH_DESERT},
            {CelestialBiomeKeys.HIGH_DESERT, CelestialBiomeKeys.HIGH_DESERT, CelestialBiomeKeys.DUNES, CelestialBiomeKeys.HIGH_DESERT, CelestialBiomeKeys.DUNES},
            {null, CelestialBiomeKeys.DUNES, null, null, CelestialBiomeKeys.HIGH_DESERT},
            {CelestialBiomeKeys.DUNES, CelestialBiomeKeys.DUNES, null, null, null}};

    public List<Climate.ParameterPoint> spawnTarget() {
        Climate.Parameter climate$parameter = Climate.Parameter.point(0.0F);
        float f = 0.16F;
        return List.of(new Climate.ParameterPoint(this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.inlandContinentalness, this.FULL_RANGE), this.FULL_RANGE, climate$parameter, Climate.Parameter.span(-1.0F, -f), 0L), new Climate.ParameterPoint(this.FULL_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.inlandContinentalness, this.FULL_RANGE), this.FULL_RANGE, climate$parameter, Climate.Parameter.span(f, 1.0F), 0L));
    }
...
//        }
    ...
    private void addOffCoastBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187196_) {
        this.addSurfaceBiome(p_187196_, this.FULL_RANGE, this.FULL_RANGE, this.mushroomFieldsContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, Biomes.DESERT);
    ...
    private void addMidSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187218_, Climate.Parameter p_187219_) {
        this.addSurfaceBiome(p_187218_, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[2]), p_187219_, 0.0F, Biomes.DESERT);
        this.addSurfaceBiome(p_187218_, this.UNFROZEN_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.nearInlandContinentalness, this.farInlandContinentalness), this.erosions[6], p_187219_, 0.0F, CelestialBiomeKeys.MONSOON_DESERT);
    ...
    private void addLowSlice(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187229_, Climate.Parameter p_187230_) {
        this.addSurfaceBiome(p_187229_, this.FULL_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[2]), p_187230_, 0.0F, Biomes.DESERT);
        this.addSurfaceBiome(p_187229_, this.UNFROZEN_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.nearInlandContinentalness, this.farInlandContinentalness), this.erosions[6], p_187230_, 0.0F, CelestialBiomeKeys.MONSOON_DESERT);
    ...
    private void addValleys(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187238_, Climate.Parameter p_187239_) {
        this.addSurfaceBiome(p_187238_, this.FROZEN_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), p_187239_, 0.0F, p_187239_.max() < 0L ? CelestialBiomeKeys.LOW_DESERT : CelestialBiomeKeys.ICY_DESERT);
        this.addSurfaceBiome(p_187238_, this.UNFROZEN_RANGE, this.FULL_RANGE, this.coastContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), p_187239_, 0.0F, p_187239_.max() < 0L ? Biomes.DESERT : CelestialBiomeKeys.LOW_DESERT);
        this.addSurfaceBiome(p_187238_, this.FROZEN_RANGE, this.FULL_RANGE, this.nearInlandContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), p_187239_, 0.0F, CelestialBiomeKeys.ICY_DESERT);
        this.addSurfaceBiome(p_187238_, this.UNFROZEN_RANGE, this.FULL_RANGE, this.nearInlandContinentalness, Climate.Parameter.span(this.erosions[0], this.erosions[1]), p_187239_, 0.0F, CelestialBiomeKeys.LOW_DESERT);
        this.addSurfaceBiome(p_187238_, this.FROZEN_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.coastContinentalness, this.farInlandContinentalness), Climate.Parameter.span(this.erosions[2], this.erosions[5]), p_187239_, 0.0F, CelestialBiomeKeys.ICY_DESERT);
        this.addSurfaceBiome(p_187238_, this.UNFROZEN_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.coastContinentalness, this.farInlandContinentalness), Climate.Parameter.span(this.erosions[2], this.erosions[5]), p_187239_, 0.0F, CelestialBiomeKeys.LOW_DESERT);
        this.addSurfaceBiome(p_187238_, this.FROZEN_RANGE, this.FULL_RANGE, this.coastContinentalness, this.erosions[6], p_187239_, 0.0F, CelestialBiomeKeys.ICY_DESERT);
        this.addSurfaceBiome(p_187238_, this.UNFROZEN_RANGE, this.FULL_RANGE, this.coastContinentalness, this.erosions[6], p_187239_, 0.0F, CelestialBiomeKeys.LOW_DESERT);
        this.addSurfaceBiome(p_187238_, this.UNFROZEN_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.inlandContinentalness, this.farInlandContinentalness), this.erosions[6], p_187239_, 0.0F, CelestialBiomeKeys.MONSOON_DESERT);
        this.addSurfaceBiome(p_187238_, this.FROZEN_RANGE, this.FULL_RANGE, Climate.Parameter.span(this.inlandContinentalness, this.farInlandContinentalness), this.erosions[6], p_187239_, 0.0F, CelestialBiomeKeys.ICY_DESERT);
...
//        this.addUndergroundBiome(p_187227_, this.FULL_RANGE, Climate.Parameter.span(0.7F, 1.0F), this.FULL_RANGE, this.FULL_RANGE, this.FULL_RANGE, 0.0F, Biomes.LUSH_CAVES);
    ...
    private ResourceKey<Biome> maybePickWindsweptSavannaBiome(int p_201991_, int p_201992_, Climate.Parameter p_201993_, ResourceKey<Biome> p_201994_) {
        return p_201991_ > 1 && p_201992_ < 4 && p_201993_.max() >= 0L ? CelestialBiomeKeys.DUNES : p_201994_;
    }
    ...
    private ResourceKey<Biome> pickBeachBiome(int p_187161_, int p_187162_) {
        if (p_187161_ == 0) {
            ...
            return p_187161_ == 4 ? Biomes.DESERT : CelestialBiomeKeys.LOW_DESERT;
        }
    }
    ...
    private ResourceKey<Biome> pickPeakBiome(int p_187241_, int p_187242_, Climate.Parameter p_187243_) {
        if (p_187241_ <= 2) {
            return p_187243_.max() < 0L ? CelestialBiomeKeys.HIGH_DESERT : CelestialBiomeKeys.ICY_DESERT;
        } else {
            return p_187241_ == 3 ? CelestialBiomeKeys.HIGH_DESERT : this.pickBadlandsBiome(p_187242_, p_187243_);
        }
    }
    ...
    private ResourceKey<Biome> pickSlopeBiome(int p_187245_, int p_187246_, Climate.Parameter p_187247_) {
        if (p_187245_ >= 3) {
            ...
            return p_187246_ <= 1 ? CelestialBiomeKeys.ICY_DESERT : CelestialBiomeKeys.HIGH_DESERT;
        }
    }
    ...
    public Climate.Parameter[] getPeaksAndValleysThresholds() {
        return new Climate.Parameter[]{Climate.Parameter.span(-2.0F, TerrainShaper.peaksAndValleys(VALLEY_SIZE)), Climate.Parameter.span(TerrainShaper.peaksAndValleys(VALLEY_SIZE), TerrainShaper.peaksAndValleys(LOW_START)), Climate.Parameter.span(TerrainShaper.peaksAndValleys(LOW_START), TerrainShaper.peaksAndValleys(HIGH_START)), Climate.Parameter.span(TerrainShaper.peaksAndValleys(HIGH_START), TerrainShaper.peaksAndValleys(PEAK_START)), Climate.Parameter.span(TerrainShaper.peaksAndValleys(PEAK_START), 2.0F)};
    }
