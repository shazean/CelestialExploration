...
//            {Biomes.FROZEN_OCEAN, null, Biomes.FROZEN_OCEAN, null, null},
...
//            {null, null, null, null, null}};
    ...
    private void addOffCoastBiomes(Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> p_187196_) {
        this.addSurfaceBiome(p_187196_, this.FULL_RANGE, this.FULL_RANGE, this.mushroomFieldsContinentalness, this.FULL_RANGE, this.FULL_RANGE, 0.0F, CelestialBiomeKeys.SHALLOW_OCEAN);
