...
public class SunTopStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public SunTopStructure() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, SunTopStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!SunTopStructure.isFeatureChunk(context)) {
        ...
        blockpos = new BlockPos(blockpos.getX(), 64 + 43, blockpos.getZ());
...
//            CelestialExploration.LOGGER.log(Level.DEBUG, "Sun top at {}", blockpos);
        }
