...
public class SunStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public SunStructure() {
        ...
        super(CODEC, SunStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!SunStructure.isFeatureChunk(context)) {
        ...
        if (structurePiecesGenerator.isPresent()) {
            CelestialExploration.LOGGER.log(Level.DEBUG, "Sun at {}", blockpos);
        }
