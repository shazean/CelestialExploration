...
public class LargeAsteroidStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public LargeAsteroidStructure() {
        super(CODEC, LargeAsteroidStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
...
//        return chunkpos.x == coordinates.x && chunkpos.z == coordinates.z;
    ...
    public static @NotNull Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!LargeAsteroidStructure.isFeatureChunk(context)) {
...
//            CelestialExploration.LOGGER.log(Level.DEBUG, "Large asteroid at {}", blockpos);
        }
