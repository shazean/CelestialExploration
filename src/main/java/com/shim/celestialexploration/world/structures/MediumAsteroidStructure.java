...
public class MediumAsteroidStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public MediumAsteroidStructure() {
        super(CODEC, MediumAsteroidStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
...
//            CelestialExploration.LOGGER.log(Level.DEBUG, "Medium asteroid at {}", blockpos);
        }
