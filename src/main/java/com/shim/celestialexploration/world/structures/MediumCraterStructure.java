...
public class MediumCraterStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public MediumCraterStructure() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, MediumCraterStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!MediumCraterStructure.isFeatureChunk(context)) {
...
//            CelestialExploration.LOGGER.log(Level.DEBUG, "Medium crater at {}", blockpos);
        }
