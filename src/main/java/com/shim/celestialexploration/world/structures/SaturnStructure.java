...
public class SaturnStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public SaturnStructure() {
        super(CODEC, SaturnStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
