...
public class LunarColonyStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public LunarColonyStructure() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, LunarColonyStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
...
//        return !context.chunkGenerator().hasFeatureChunkInRange(BuiltinStructureSets.OCEAN_MONUMENTS, context.seed(), chunkPos.x, chunkPos.z, 10);
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!LunarColonyStructure.isFeatureChunk(context)) {
