...
public class JupiterDungeonStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public JupiterDungeonStructure() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, JupiterDungeonStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!JupiterDungeonStructure.isFeatureChunk(context)) {
        ...
        if (structurePiecesGenerator.isPresent()) {
            CelestialExploration.LOGGER.log(Level.DEBUG, "Jupiter dungeon at {}", blockpos);
        }
