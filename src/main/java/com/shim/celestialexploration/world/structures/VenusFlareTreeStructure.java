...
public class VenusFlareTreeStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public VenusFlareTreeStructure() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, VenusFlareTreeStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!VenusFlareTreeStructure.isFeatureChunk(context)) {
...
//        blockpos = blockpos.below(1);
        ...
        if (structurePiecesGenerator.isPresent()) {
            CelestialExploration.LOGGER.log(Level.DEBUG, "Venus flare tree at {}", blockpos);
        }
