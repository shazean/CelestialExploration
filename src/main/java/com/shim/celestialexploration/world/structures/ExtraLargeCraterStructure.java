...
public class ExtraLargeCraterStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public ExtraLargeCraterStructure() {
        super(CODEC, ExtraLargeCraterStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        if (!ExtraLargeCraterStructure.isFeatureChunk(context)) {
