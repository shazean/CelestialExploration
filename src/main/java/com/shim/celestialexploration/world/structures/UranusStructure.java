...
public class UranusStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public UranusStructure() {
        super(CODEC, UranusStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    private static boolean isFeatureChunk(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        Vec3 coordinates = CelestialUtil.getPlanetaryChunkCoordinates(7);
    ...
    public static @NotNull Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!UranusStructure.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            CelestialExploration.LOGGER.log(Level.DEBUG, "Uranus at {}", blockpos);
        }
