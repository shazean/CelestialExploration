...
public class NeptuneStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public NeptuneStructure() {
        super(CODEC, NeptuneStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    private static boolean isFeatureChunk(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        Vec3 coordinates = CelestialUtil.getPlanetaryChunkCoordinates(8);
    ...
    public static @NotNull Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!NeptuneStructure.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            CelestialExploration.LOGGER.log(Level.DEBUG, "Neptune at {}", blockpos);
        }
