...
public class MarsColonyStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public MarsColonyStructure() {
        super(CODEC, MarsColonyStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!MarsColonyStructure.isFeatureChunk(context)) {
