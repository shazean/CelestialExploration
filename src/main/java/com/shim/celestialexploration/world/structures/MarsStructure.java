...
public class MarsStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public MarsStructure() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, MarsStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    private static boolean isFeatureChunk(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        Vec3 coordinates = CelestialUtil.getPlanetaryChunkCoordinates(4);
    ...
    public static @NotNull Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!MarsStructure.isFeatureChunk(context)) {
...
//            CelestialExploration.LOGGER.log(Level.DEBUG, "Mars planet at {}", blockpos);
        }
