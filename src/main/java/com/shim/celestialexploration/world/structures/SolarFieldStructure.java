...
public class SolarFieldStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public SolarFieldStructure() {
        super(CODEC, SolarFieldStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!SolarFieldStructure.isFeatureChunk(context)) {
...
//            CelestialExploration.LOGGER.log(Level.DEBUG, "Solar field at {}", blockpos);
//        }
