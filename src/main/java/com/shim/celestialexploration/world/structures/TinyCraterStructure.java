...
public class TinyCraterStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public TinyCraterStructure() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, TinyCraterStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!TinyCraterStructure.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            CelestialExploration.LOGGER.log(Level.DEBUG, "Tiny crater at {}", blockpos);
        }
