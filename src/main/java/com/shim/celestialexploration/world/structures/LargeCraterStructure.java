...
public class LargeCraterStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public LargeCraterStructure() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, LargeCraterStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!LargeCraterStructure.isFeatureChunk(context)) {
