...
public class MarsDungeonStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public MarsDungeonStructure() {
        super(CODEC, MarsDungeonStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!MarsDungeonStructure.isFeatureChunk(context)) {
