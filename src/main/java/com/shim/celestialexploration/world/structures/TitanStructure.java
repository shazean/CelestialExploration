...
public class TitanStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public TitanStructure() {
        super(CODEC, TitanStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    private static boolean isFeatureChunk(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        return chunkpos.x == coordinates.x + 4 && chunkpos.z == coordinates.z + 4;
    }
    ...
    public static @NotNull Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!TitanStructure.isFeatureChunk(context)) {
            return Optional.empty();
        }

        BlockPos blockpos = context.chunkPos().getMiddleBlockPosition(0);
        blockpos = new BlockPos(blockpos.getX(), 64 + 36, blockpos.getZ());
        ...
        if(structurePiecesGenerator.isPresent()) {
            CelestialExploration.LOGGER.log(Level.DEBUG, "Titan at {}", blockpos);
        }
