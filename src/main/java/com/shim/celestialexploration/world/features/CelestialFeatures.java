...
//    public static final Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> GEYSER = FeatureUtils.register("geyser", Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(BlockRegistry.GEYSER.get())), List.of(BlockRegistry.VENUS_STONE.get(), BlockRegistry.VENUS_SAND.get())));

//    public static final Holder<ConfiguredFeature<DiskConfiguration, ?>> GLOWING_SAND = FeatureUtils.register("glowing_sand", Feature.DISK, new DiskConfiguration(BlockRegistry.GLOWING_MOON_SAND.get().defaultBlockState(), UniformInt.of(3, 8), 3, List.of(BlockRegistry.MOON_SAND.get().defaultBlockState())));

//    public static final Holder<ConfiguredFeature<DiskConfiguration, ?>> GEYSER = FeatureUtils.register("geyser", Feature.DISK, new DiskConfiguration(BlockRegistry.GEYSER.get().defaultBlockState(), UniformInt.of(2, 6), 1, List.of(BlockRegistry.VENUS_STONE.get().defaultBlockState(), BlockRegistry.VENUS_SAND.get().defaultBlockState())));
    //FeatureRegistry.GEYSER.get());
