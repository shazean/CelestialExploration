...
public class CelestialFeaturePlacements {
    ...
    //---- ORES -------------------------------------------------------------------------------
    public static final Holder<PlacedFeature> MOON_IRON_ORE_UPPER = PlacementUtils.register("moon_iron_ore_upper", CelestialOreFeatures.MOON_IRON_ORE, CelestialOrePlacement.commonOrePlacement(90, HeightRangePlacement.triangle(VerticalAnchor.absolute(80), VerticalAnchor.absolute(384))));
