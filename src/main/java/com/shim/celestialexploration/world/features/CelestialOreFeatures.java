...
public class CelestialOreFeatures {
    ...
    public static final List<OreConfiguration.TargetBlockState> METEOR_COAL_ORES = List.of(
            OreConfiguration.target(METEOR_REPLACEABLES, BlockRegistry.METEOR_COAL_ORE.get().defaultBlockState()));

    public static final List<OreConfiguration.TargetBlockState> METEOR_COPPER_ORES = List.of(
            OreConfiguration.target(METEOR_REPLACEABLES, BlockRegistry.METEOR_COPPER_ORE.get().defaultBlockState()));

    public static final List<OreConfiguration.TargetBlockState> METEOR_DIAMOND_ORES = List.of(
            OreConfiguration.target(METEOR_REPLACEABLES, BlockRegistry.METEOR_DIAMOND_ORE.get().defaultBlockState()));

    public static final List<OreConfiguration.TargetBlockState> METEOR_EMERALD_ORES = List.of(
            OreConfiguration.target(METEOR_REPLACEABLES, BlockRegistry.METEOR_EMERALD_ORE.get().defaultBlockState()));

    public static final List<OreConfiguration.TargetBlockState> METEOR_GOLD_ORES = List.of(
            OreConfiguration.target(METEOR_REPLACEABLES, BlockRegistry.METEOR_GOLD_ORE.get().defaultBlockState()));

    public static final List<OreConfiguration.TargetBlockState> METEOR_IRON_ORES = List.of(
            OreConfiguration.target(METEOR_REPLACEABLES, BlockRegistry.METEOR_IRON_ORE.get().defaultBlockState()));

    public static final List<OreConfiguration.TargetBlockState> METEOR_LAPIS_ORES = List.of(
            OreConfiguration.target(METEOR_REPLACEABLES, BlockRegistry.METEOR_LAPIS_ORE.get().defaultBlockState()));

    public static final List<OreConfiguration.TargetBlockState> METEOR_REDSTONE_ORES = List.of(
            OreConfiguration.target(METEOR_REPLACEABLES, BlockRegistry.METEOR_REDSTONE_ORE.get().defaultBlockState()));
    ...
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> MARS_IRON_ORE = FeatureUtils.register("mars_iron_ore", Feature.ORE, new OreConfiguration(MARS_IRON_ORES, 8));
