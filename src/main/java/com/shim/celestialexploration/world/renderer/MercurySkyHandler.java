...
public class MercurySkyHandler extends AbstractSkyHandler {
    protected static final ResourceLocation CLOSE_UP_SUN_LOCATION = new ResourceLocation(CelestialExploration.MODID, "textures/environment/sun_close_up.png");
    ...
    public void render(int ticks, float partialTick, PoseStack poseStack, ClientLevel level, Minecraft minecraft) {
        ...
        renderSun(poseStack, level, partialTick, 0, 0, CLOSE_UP_SUN_LOCATION, 55.0F);
