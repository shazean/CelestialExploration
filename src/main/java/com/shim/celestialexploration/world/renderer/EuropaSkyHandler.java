...
public class EuropaSkyHandler extends AbstractSkyHandler {
    ...
    public void render(int ticks, float partialTick, PoseStack poseStack, ClientLevel level, Minecraft minecraft) {
        ...
        renderMoon(poseStack, level, partialTick, 0, 0, JUPITER_LOCATION, 80.0F);
        renderMoon(poseStack, level, partialTick, 40, -30, IO_LOCATION, 18.0F);
...
//        BufferUploader.end(bufferbuilder);
//        f12 = 80.0F; //20.0F
//        RenderSystem.setShaderTexture(0, JUPITER_LOCATION);
