...
//    IRON_SPACESUIT("iron_space_suit", 16, new int[]{2, 5, 6, 2}, 10, SoundEvents.ARMOR_EQUIP_IRON, 0.1F, 0.0F, () -> Ingredient.of(Tags.Items.INGOTS_IRON)),
//
//    STEEL_SPACESUIT("steel_space_suit", 21, new int[]{2, 5, 7, 2}, 10, SoundEvents.ARMOR_EQUIP_IRON, 0.1F, 0.0F, () -> Ingredient.of(ItemRegistry.STEEL_INGOT.get())),
//
//    COPPER_SPACESUIT("copper_space_suit", 13, new int[]{2, 5, 6, 2}, 20, SoundEvents.ARMOR_EQUIP_GOLD, 0.1F, 0.0F, () -> Ingredient.of(Tags.Items.INGOTS_COPPER)),
//
//    GOLD_SPACESUIT("gold_space_suit", 8, new int[]{1, 3, 5, 2}, 28, SoundEvents.ARMOR_EQUIP_GOLD, 0.1F, 0.0F, () -> Ingredient.of(Tags.Items.INGOTS_GOLD)),
//
//    DIAMOND_SPACESUIT("diamond_space_suit", 35, new int[]{3, 6, 8, 3}, 12, SoundEvents.ARMOR_EQUIP_DIAMOND, 2.1F, 0.0F, () -> Ingredient.of(Tags.Items.GEMS_DIAMOND)),
//
//    NETHERITE_SPACESUIT("netherite_space_suit", 39, new int[]{3, 7, 9, 3}, 17, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.3F, 0.1F, () -> Ingredient.of(Tags.Items.INGOTS_NETHERITE));
