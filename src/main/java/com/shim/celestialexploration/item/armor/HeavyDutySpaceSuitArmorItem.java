...
public class HeavyDutySpaceSuitArmorItem extends ArmorItem implements GeoItem {
    ...
    public HeavyDutySpaceSuitArmorItem(ArmorMaterial material, EquipmentSlot slot, Properties properties) {
    ...
    public void initializeClient(Consumer<IItemRenderProperties> consumer) {
        consumer.accept(new IItemRenderProperties() {
            ...
            public HumanoidModel<?> getArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot armorSlot, HumanoidModel<?> original) {
                if (renderer == null)
                    renderer = new HeavyDutySpaceSuitRenderer();
