...
//
    public static final RegistryObject<VillagerProfession> ASTRONOMER = VILLAGER_PROFESSIONS.register("astronomer",
            () -> new VillagerProfession("astronomer", PoiRegistry.ASTRONOMY_POI.get(), ImmutableSet.of(), ImmutableSet.of(), SoundEvents.VILLAGER_WORK_CARTOGRAPHER));
////
    public static final RegistryObject<VillagerProfession> ENGINEER = VILLAGER_PROFESSIONS.register("engineer",
            () -> new VillagerProfession("engineer", PoiRegistry.ENGINEER_POI.get(), ImmutableSet.of(), ImmutableSet.of(), SoundEvents.VILLAGER_WORK_TOOLSMITH));
