...
import com.shim.celestiallib.api.world.CLibSurfaceRules;
...
public class CelestialNoises extends NoiseRouterData {
    ...
    public static final RegistryObject<NoiseGeneratorSettings> MARS_NOISE = NOISES.register("mars", () -> {
        ...
        return new NoiseGeneratorSettings(noisesettings, CelestialBlocks.MARS_STONE.get().defaultBlockState(), Blocks.AIR.defaultBlockState(), NoiseRouterData.overworld(noisesettings, false),
    ...
    public static final RegistryObject<NoiseGeneratorSettings> MOON_NOISE = NOISES.register("moon", () -> {
        ...
        return new NoiseGeneratorSettings(noisesettings, CelestialBlocks.MOON_STONE.get().defaultBlockState(), Blocks.AIR.defaultBlockState(), NoiseRouterData.overworldWithoutCaves(noisesettings),
    ...
    public static final RegistryObject<NoiseGeneratorSettings> VENUS_NOISE = NOISES.register("venus", () -> {
        ...
        return new NoiseGeneratorSettings(noisesettings, CelestialBlocks.VENUS_STONE.get().defaultBlockState(), CelestialFluids.SULFUR_BLOCK.get().defaultBlockState(), NoiseRouterData.overworld(noisesettings, false),
    ...
    public static final RegistryObject<NoiseGeneratorSettings> MERCURY_NOISE = NOISES.register("mercury", () -> {
        ...
        return new NoiseGeneratorSettings(noisesettings, CelestialBlocks.MERCURY_STONE.get().defaultBlockState(), Blocks.AIR.defaultBlockState(), NoiseRouterData.overworldWithoutCaves(noisesettings),
                CelestialSurfaceRules.mercury(), 0, false, true, false, false);
    });

    public static final RegistryObject<NoiseGeneratorSettings> MILKY_WAY_NOISE = NOISES.register("milky_way", () -> {
        NoiseSettings noisesettings = milkyWayNoiseSettings();
        return new NoiseGeneratorSettings(noisesettings, Blocks.AIR.defaultBlockState(), Blocks.AIR.defaultBlockState(), NoiseRouterData.overworld(noisesettings, false),
                CLibSurfaceRules.space(), -64, false, false, false, false);
    });
    ...
    public static final RegistryObject<NoiseGeneratorSettings> JUPITER_NOISE = NOISES.register("jupiter", () -> {
        ...
        return new NoiseGeneratorSettings(noisesettings, CelestialBlocks.JUPITER_DEEPSLATE.get().defaultBlockState(), CelestialFluids.METALLIC_HYDROGEN_BLOCK.get().defaultBlockState(), NoiseRouterData.overworldWithoutCaves(noisesettings),
    ...
    public static final RegistryObject<NoiseGeneratorSettings> EUROPA_NOISE = NOISES.register("europa", () -> {
        ...
        return new NoiseGeneratorSettings(noisesettings, CelestialBlocks.MOON_STONE.get().defaultBlockState(), Blocks.WATER.defaultBlockState(), NoiseRouterData.overworldWithoutCaves(noisesettings),
    ...
    public static final RegistryObject<NoiseGeneratorSettings> CALLISTO_NOISE = NOISES.register("callisto", () -> {
        ...
        return new NoiseGeneratorSettings(noisesettings, CelestialBlocks.MOON_DEEPSLATE.get().defaultBlockState(), Blocks.AIR.defaultBlockState(), NoiseRouterData.overworldWithoutCaves(noisesettings),
                CelestialSurfaceRules.callisto(), 0, false, true , false, false);
    });

    public static final RegistryObject<NoiseGeneratorSettings> IO_NOISE = NOISES.register("io", () -> {
        NoiseSettings noisesettings = ioNoiseSettings();
        return new NoiseGeneratorSettings(noisesettings, CelestialBlocks.IO_STONE.get().defaultBlockState(), Blocks.AIR.defaultBlockState(), NoiseRouterData.overworldWithoutCaves(noisesettings),
                CelestialSurfaceRules.io(), 0, false, true , false, false);
    });

    public static final RegistryObject<NoiseGeneratorSettings> GANYMEDE_NOISE = NOISES.register("ganymede", () -> {
        NoiseSettings noisesettings = ganymedeNoiseSettings();
        return new NoiseGeneratorSettings(noisesettings, CelestialBlocks.MOON_STONE.get().defaultBlockState(), Blocks.WATER.defaultBlockState(), NoiseRouterData.overworldWithoutCaves(noisesettings),
    ...
    static NoiseSettings milkyWayNoiseSettings() {
    ...
    static NoiseSettings ioNoiseSettings() {
        return NoiseSettings.create(-32, 256, new NoiseSamplingSettings(1.0D, 1.0D, 80.0D, 160.0D),
                new NoiseSlider(-0.078125D, 2, 8), new NoiseSlider(0.1171875D, 3, 0), 1, 2, TerrainProvider.overworld(false));
    }
