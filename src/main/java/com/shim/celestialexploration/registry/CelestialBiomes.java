...
public class CelestialBiomes {
    ...
    //---- MOON -------------------------------------------------------------------------------
    public static final RegistryObject<Biome> MOON_CRATERS = BIOMES.register("moon_craters", () -> MoonBiomes.craters(false));
    public static final RegistryObject<Biome> MOON_DESERT = BIOMES.register("moon_desert", () -> MoonBiomes.desert(false));
    public static final RegistryObject<Biome> MOON_LAVA_FLATS = BIOMES.register("moon_lava_flats", () -> MoonBiomes.lavaFlats(false));
    public static final RegistryObject<Biome> MOON_LOWER_PLAINS = BIOMES.register("moon_lower_plains", () -> MoonBiomes.desert(false));
    ...
    //EUROPA
    public static final RegistryObject<Biome> EUROPA_DESERT = BIOMES.register("europa_desert", () -> MoonBiomes.desert(false));
    ...
    //CALLISTO
    public static final RegistryObject<Biome> CALLISTO_CRATERED_PLAINS = BIOMES.register("callisto_cratered_plains", () -> MoonBiomes.craters(false));
    public static final RegistryObject<Biome> CALLISTO_DESERT = BIOMES.register("callisto_desert", () -> MoonBiomes.desert(false));
    public static final RegistryObject<Biome> CALLISTO_LOWER_PLAINS = BIOMES.register("callisto_lower_plains", () -> MoonBiomes.desert(false));
    ...
    //GANYMEDE
    public static final RegistryObject<Biome> GANYMEDE_CRATERED_PLAINS = BIOMES.register("ganymede_cratered_plains", () -> MoonBiomes.craters(true));
