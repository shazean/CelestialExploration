...
public class EffectRegistry {
    public static final DeferredRegister<MobEffect> MOB_EFFECTS
            = DeferredRegister.create(ForgeRegistries.MOB_EFFECTS, CelestialExploration.MODID);

    public static final RegistryObject<MobEffect> LOW_GRAVITY = MOB_EFFECTS.register("low_gravity", () -> new GravityEffect(MobEffectCategory.NEUTRAL, 5926017).addAttributeModifier(ForgeMod.ENTITY_GRAVITY.get(), "503FE595-3498-8478-234A-3EC09BF892EF", -0.05D, AttributeModifier.Operation.ADDITION));
