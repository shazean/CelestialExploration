...
public class ItemRegistry {
	...
	public static final RegistryObject<ArmorItem> ADVANCED_SPACESUIT_HELMET = registerItem("advanced_spacesuit_helmet", "Advanced Spacesuit Helmet", () -> new SpacesuitArmorItem(ModArmorMaterials.ADVANCED_SPACESUIT, EquipmentSlot.HEAD, (new Item.Properties()).tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
	public static final RegistryObject<ArmorItem> ADVANCED_SPACESUIT_BOOTS = registerItem("advanced_spacesuit_boots", "Advanced Spacesuit Boots", () -> new SpacesuitArmorItem(ModArmorMaterials.ADVANCED_SPACESUIT, EquipmentSlot.FEET, (new Item.Properties()).tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
	public static final RegistryObject<ArmorItem> ADVANCED_SPACESUIT_CHESTPLATE = registerItem("advanced_spacesuit_chestplate", "Advanced Spacesuit Chestplate", () -> new SpacesuitArmorItem(ModArmorMaterials.ADVANCED_SPACESUIT, EquipmentSlot.CHEST, (new Item.Properties()).tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
	public static final RegistryObject<ArmorItem> ADVANCED_SPACESUIT_LEGGINGS = registerItem("advanced_spacesuit_leggings", "Advanced Spacesuit Leggings", () -> new SpacesuitArmorItem(ModArmorMaterials.ADVANCED_SPACESUIT, EquipmentSlot.LEGS, (new Item.Properties()).tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
	...
	public static final RegistryObject<Item> MARS_MALLOW_SPAWN_EGG = registerItem("mars_mallow_spawn_egg", "Mars Mallow Spawn Egg", () -> new ForgeSpawnEggItem(EntityRegistry.MARS_MALLOW, 0xfaf5ee, 0xcda568, new Item.Properties().tab(CelestialExploration.CELESTIAL_MISC_TAB)));
	public static final RegistryObject<Item> QUICKSILVER_SPAWN_EGG = registerItem("quicksilver_spawn_egg", "Quicksilver Spawn Egg", () -> new ForgeSpawnEggItem(EntityRegistry.QUICKSILVER_SLIME,0xb4b4b4, 0xc8abab, new Item.Properties().tab(CelestialExploration.CELESTIAL_MISC_TAB)));
	public static final RegistryObject<Item> VISCOUS_SPAWN_EGG = registerItem("viscous_spawn_egg", "Viscous Spawn Egg", () -> new ForgeSpawnEggItem(EntityRegistry.VISCOUS_SLIME,0x525964, 0xb4b4b4, new Item.Properties().tab(CelestialExploration.CELESTIAL_MISC_TAB)));
	public static final RegistryObject<Item> LURKER_SPAWN_EGG = registerItem("lurker_spawn_egg", "Lurker Spawn Egg", () -> new ForgeSpawnEggItem(EntityRegistry.LURKER,0x00a100, 0xffffff, new Item.Properties().tab(CelestialExploration.CELESTIAL_MISC_TAB)));
	public static final RegistryObject<Item> VOIDFELLOW_SPAWN_EGG = registerItem("voidfellow_spawn_egg", "Space Fellow Spawn Egg", () -> new ForgeSpawnEggItem(EntityRegistry.VOIDFELLOW,0x1d1024, 0x0b4647, new Item.Properties().tab(CelestialExploration.CELESTIAL_MISC_TAB)));
	public static final RegistryObject<Item> VOIDED_SPAWN_EGG = registerItem("voided_spawn_egg", "Voided Spawn Egg", () -> new ForgeSpawnEggItem(EntityRegistry.VOIDED,0x413245, 0x3c2d42, new Item.Properties().tab(CelestialExploration.CELESTIAL_MISC_TAB)));
	public static final RegistryObject<Item> SULFUR_CUBE_SPAWN_EGG = registerItem("sulfur_cube_spawn_egg", "Sulfur Cube Spawn Egg", () -> new ForgeSpawnEggItem(EntityRegistry.SULFUR_CUBE,0x794d00, 0x3e77ff, new Item.Properties().tab(CelestialExploration.CELESTIAL_MISC_TAB)));
	public static final RegistryObject<Item> VOIDED_PIGLIN_SPAWN_EGG = registerItem("voided_piglin_spawn_egg", "Voided Piglin Spawn Egg", () -> new ForgeSpawnEggItem(EntityRegistry.VOIDED_PIGLIN,0xe9a3bb, 0x583b5e, new Item.Properties().tab(CelestialExploration.CELESTIAL_MISC_TAB)));
	...
	public static final RegistryObject<Item> METEOR_CRAWLER_SPAWN_EGG = registerItem("meteor_crawler_spawn_egg", "Meteor Crawler Spawn Egg", () -> new ForgeSpawnEggItem(EntityRegistry.METEOR_CRAWLER,0x3f3430, 0x211713, new Item.Properties().tab(CelestialExploration.CELESTIAL_MISC_TAB)));
...
//	public static final RegistryObject<Item> MECHADOG_HEAD = ITEMS.register("mechadog_head", () -> new StandingAndWallBlockItem(BlockRegistry.MECHADOG_HEAD.get(), BlockRegistry.MECHADOG_WALL_HEAD.get(), (new Item.Properties()).tab(CreativeModeTab.TAB_DECORATIONS).rarity(Rarity.UNCOMMON)));
	...
	public static final RegistryObject<Item> IO_DUST = registerItem("io_dust", "Ionian Dust", () -> new Item((new Item.Properties()).tab(CelestialExploration.CELESTIAL_MISC_TAB)));
	public static final RegistryObject<Item> GANYMEDE_DUST = registerItem("ganymede_dust", "Ganymedian Dust", () -> new Item((new Item.Properties()).tab(CelestialExploration.CELESTIAL_MISC_TAB)));
