...
public class ItemRegistry {
	...
	public static final RegistryObject<Item> CYBORG_PIGLIN_SPAWN_EGG = registerItem("cyborg_piglin_spawn_egg", "Cyborg Piglin Spawn Egg", () -> new ForgeSpawnEggItem(EntityRegistry.CYBORG_PIGLIN,0, 0x3c2d62, new Item.Properties().tab(CelestialExploration.CELESTIAL_MISC_TAB)));
