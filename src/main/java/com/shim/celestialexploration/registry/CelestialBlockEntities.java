...
public class CelestialBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<StoneChestBlockEntity>> STONE_CHEST_BLOCK_ENTITY = BLOCK_ENTITIES.register("chest", () -> BlockEntityType.Builder.of(StoneChestBlockEntity::new, CelestialBlocks.MARS_CHEST.get(), CelestialBlocks.MOON_CHEST.get(), CelestialBlocks.VENUS_CHEST.get(), CelestialBlocks.MERCURY_CHEST.get(), CelestialBlocks.JUPITER_CHEST.get(), CelestialBlocks.IO_CHEST.get()).build(null));
    public static final RegistryObject<BlockEntityType<DisplayBoardBlockEntity>> DISPLAY_BOARD_BLOCK_ENTITY = BLOCK_ENTITIES.register("display_board", () -> BlockEntityType.Builder.of(DisplayBoardBlockEntity::new, CelestialBlocks.RED_DISPLAY_BOARD.get(), CelestialBlocks.BLACK_DISPLAY_BOARD.get(), CelestialBlocks.BLUE_DISPLAY_BOARD.get(), CelestialBlocks.WHITE_DISPLAY_BOARD.get(), CelestialBlocks.RED_WALL_DISPLAY_BOARD.get(), CelestialBlocks.BLACK_WALL_DISPLAY_BOARD.get(), CelestialBlocks.BLUE_WALL_DISPLAY_BOARD.get(), CelestialBlocks.WHITE_WALL_DISPLAY_BOARD.get()).build(null));
    ...
    public static final RegistryObject<BlockEntityType<OxygenGeneratorBlockEntity>> OXYGEN_GENERATOR_BLOCK_ENTITY = BLOCK_ENTITIES.register("oxygen_generator", () -> BlockEntityType.Builder.of(OxygenGeneratorBlockEntity::new, CelestialBlocks.OXYGEN_GENERATOR.get()).build(null));
