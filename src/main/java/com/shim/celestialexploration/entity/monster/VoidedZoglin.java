...
public class VoidedZoglin extends Zoglin implements HoglinBase {
    ...
    public boolean isTargetable(LivingEntity p_34253_) {
        ...
        return entitytype != EntityType.ZOGLIN && entitytype != CelestialEntities.VOIDED_ZOGLIN.get() && entitytype != EntityType.CREEPER && Sensor.isEntityAttackable(this, p_34253_);
    }
}
