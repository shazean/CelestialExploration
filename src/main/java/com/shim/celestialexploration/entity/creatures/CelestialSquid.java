...
//
//public class CelestialSquid extends PathfinderMob {
...
//    private float tz;
//
//    public CelestialSquid(EntityType<? extends PathfinderMob> p_29953_, Level p_29954_) {
...
//        this.goalSelector.addGoal(0, new CelestialSquid.SquidRandomMovementGoal(this));
//        this.goalSelector.addGoal(1, new CelestialSquid.SquidFleeGoal());
//    }
//
...
//            LivingEntity livingentity = CelestialSquid.this.getLastHurtByMob();
//            if (
//                //CelestialSquid.this.isInWater() &&
//                    livingentity != null) {
//                return CelestialSquid.this.distanceToSqr(livingentity) < 100.0D;
//            } else {
//                return false;
//            }
//        }
...
//                Vec3 vec3 = new Vec3(CelestialSquid.this.getX() - livingentity.getX(), CelestialSquid.this.getY() - livingentity.getY(), CelestialSquid.this.getZ() - livingentity.getZ());
//                BlockState blockstate = CelestialSquid.this.level.getBlockState(new BlockPos(CelestialSquid.this.getX() + vec3.x, CelestialSquid.this.getY() + vec3.y, CelestialSquid.this.getZ() + vec3.z));
//                FluidState fluidstate = CelestialSquid.this.level.getFluidState(new BlockPos(CelestialSquid.this.getX() + vec3.x, CelestialSquid.this.getY() + vec3.y, CelestialSquid.this.getZ() + vec3.z));
//                if (
...
//                    }
//
//                    CelestialSquid.this.setMovementVector((float) vec3.x / 20.0F, (float) vec3.y / 20.0F, (float) vec3.z / 20.0F);
//                }
//
//                if (this.fleeTicks % 10 == 5) {
//                    CelestialSquid.this.level.addParticle(ParticleTypes.BUBBLE, CelestialSquid.this.getX(), CelestialSquid.this.getY(), CelestialSquid.this.getZ(), 0.0D, 0.0D, 0.0D);
//                }
//
//            }
//        }
...
//        private final CelestialSquid squid;
//
//        public SquidRandomMovementGoal(CelestialSquid p_30004_) {
//            this.squid = p_30004_;
//        }
//
//        public boolean canUse() {
...
//            } else if (this.squid.getRandom().nextInt(reducedTickDelay(50)) == 0
////                    || !this.squid.wasTouchingWater
