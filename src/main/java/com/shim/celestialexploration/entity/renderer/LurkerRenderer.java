...
public class LurkerRenderer extends MobRenderer<LurkerEntity, LurkerModel<LurkerEntity>> {
    ...
    protected void scale(LurkerEntity p_114046_, PoseStack p_114047_, float p_114048_) {
    ...
    protected float getWhiteOverlayProgress(LurkerEntity p_114043_, float p_114044_) {
        float f = p_114043_.getSwelling(p_114044_);
        return (int)(f * 10.0F) % 2 == 0 ? 0.0F : Mth.clamp(f, 0.5F, 1.0F);
    }

    public ResourceLocation getTextureLocation(LurkerEntity p_114041_) {
