...
public class RustSlimeRenderer extends MobRenderer<RustSlimeEntity, RustSlimeModel<RustSlimeEntity>> {
    ...
    public void render(RustSlimeEntity p_115976_, float p_115977_, float p_115978_, PoseStack p_115979_, MultiBufferSource p_115980_, int p_115981_) {
        this.shadowRadius = 0.25F * (float)p_115976_.getSize();
        super.render(p_115976_, p_115977_, p_115978_, p_115979_, p_115980_, p_115981_);
    }


    protected void scale(RustSlimeEntity p_115983_, PoseStack p_115984_, float p_115985_) {
        float f = 0.999F;
    ...
    public ResourceLocation getTextureLocation(RustSlimeEntity slime) {
