...
public class MagCartRenderer<T extends AbstractMagCart> extends EntityRenderer<T> {
    private static final ResourceLocation MINECART_LOCATION = new ResourceLocation(CelestialExploration.MODID, "textures/entity/magcart.png");
...
//        double d3 = 0.3F;
        ...
        if (vec3 != null) {
            ...
            p_115421_.translate(vec3.x - d0, (vec31.y + vec32.y) / 2.0D - d1, vec3.z - d2); //vec3.x - d0, (vec31.y + vec32.y) / 2.0D - d1, vec3.z - d2
            Vec3 vec33 = vec32.add(vec31.x, -vec31.y, -vec31.z); //-vec31.x, -vec31.y, -vec31.z
        ...
        p_115421_.translate(0.0D, 1.625D, 0.0D); //0.0, 0.375, 0.0
...
//            float f4 = 0.75F;
            ...
            p_115421_.translate(-0.5D, (double)((float)(j - 8) / 16.0F) - 1.35F, 0.5D);
