...
@OnlyIn(Dist.CLIENT)
public class MarsMallowOuterLayer<T extends LivingEntity> extends RenderLayer<T, MarsMallowModel<T>> {
    private final EntityModel<T> model;

    public MarsMallowOuterLayer(RenderLayerParent<T, MarsMallowModel<T>> p_174536_, EntityModelSet p_174537_) {
        super(p_174536_);
        this.model = new MarsMallowModel<>(p_174537_.bakeLayer(ModelLayers.SLIME_OUTER));
    }
