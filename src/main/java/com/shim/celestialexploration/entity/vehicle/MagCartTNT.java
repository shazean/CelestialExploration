...
public class MagCartTNT extends AbstractMagCart {
    ...
    public float getBlockExplosionResistance(Explosion p_38675_, BlockGetter p_38676_, BlockPos p_38677_, BlockState p_38678_, FluidState p_38679_, float p_38680_) {
        return !this.isPrimed() || !p_38678_.is(CelestialTags.Blocks.MAGRAIL) && !p_38676_.getBlockState(p_38677_.above()).is(CelestialTags.Blocks.MAGRAIL) ? super.getBlockExplosionResistance(p_38675_, p_38676_, p_38677_, p_38678_, p_38679_, p_38680_) : 0.0F;
    }
    ...
    public boolean shouldBlockExplode(Explosion p_38669_, BlockGetter p_38670_, BlockPos p_38671_, BlockState p_38672_, float p_38673_) {
        return (!this.isPrimed() || !p_38672_.is(CelestialTags.Blocks.MAGRAIL) && !p_38670_.getBlockState(p_38671_.above()).is(CelestialTags.Blocks.MAGRAIL)) && super.shouldBlockExplode(p_38669_, p_38670_, p_38671_, p_38672_, p_38673_);
    }
