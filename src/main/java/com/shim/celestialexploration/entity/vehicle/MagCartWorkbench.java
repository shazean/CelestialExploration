...
//
//public class MagCartWorkbench extends AbstractMagCart {
//    private static final EntityDataAccessor<Boolean> DATA_ID_FUEL = SynchedEntityData.defineId(MagCartWorkbench.class, EntityDataSerializers.BOOLEAN);
//    private int fuel;
//    public double xPush;
//    public double zPush;
//    private static final Ingredient INGREDIENT = Ingredient.of(Items.COAL, Items.CHARCOAL);
//
//    public MagCartWorkbench(EntityType<? extends MagCartWorkbench> p_38552_, Level p_38553_) {
//        super(p_38552_, p_38553_);
//    }
//
//    public MagCartWorkbench(Level p_38555_, double p_38556_, double p_38557_, double p_38558_) {
//        super(EntityRegistry.WORKBENCH_MAGCART.get(), p_38555_, p_38556_, p_38557_, p_38558_);
//    }
//
//    public MagCartWorkbench.Type getMagCartType() {
...
//            this.spawnAtLocation(BlockRegistry.WORKBENCH.get());
//        }
//
//    }
//
...
//        return BlockRegistry.WORKBENCH.get().defaultBlockState().setValue(FurnaceBlock.FACING, Direction.NORTH).setValue(FurnaceBlock.LIT, this.hasFuel());
