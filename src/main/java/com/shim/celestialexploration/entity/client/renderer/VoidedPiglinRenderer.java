...
import com.shim.celestialexploration.entity.client.layers.PiglinHelmetLayer;
...
public class VoidedPiglinRenderer extends HumanoidMobRenderer<VoidedPiglin, PiglinModel<VoidedPiglin>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(CelestialExploration.MODID, "textures/entity/piglin/voided_piglin.png");
