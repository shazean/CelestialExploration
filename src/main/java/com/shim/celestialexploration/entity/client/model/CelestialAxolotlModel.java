...
//
//@OnlyIn(Dist.CLIENT)
//public class CelestialAxolotlModel<T extends CelestialAxolotl & LerpingModel> extends AgeableListModel<T> {
...
//
//    public CelestialAxolotlModel(ModelPart p_170370_) {
...
//    }
//
//    public void setupAnim(T axolotl, float p_170396_, float p_170397_, float p_170398_, float p_170399_, float p_170400_) {
//        this.setupInitialAnimationValues(axolotl, p_170399_, p_170400_);
//        if (axolotl.isPlayingDead()) {
//            this.setupPlayDeadAnimation(p_170399_);
//            this.saveAnimationValues(axolotl);
//        } else {
//            boolean isMoving = axolotl.getDeltaMovement().horizontalDistanceSqr() > 1.0E-7D || axolotl.getXRot() != axolotl.xRotO || axolotl.getYRot() != axolotl.yRotO || axolotl.xOld != axolotl.getX() || axolotl.zOld != axolotl.getZ();
//            if (!axolotl.isOnGround()) { //axolotl.isInWaterOrBubble()) {
//                if (isMoving) {
