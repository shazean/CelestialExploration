...
@OnlyIn(Dist.CLIENT)
public class SpaceLlamaModel<T extends AbstractChestedHorse> extends EntityModel<T> {
    ...
    public SpaceLlamaModel(ModelPart p_170724_) {
    ...
    public static LayerDefinition createBodyLayer(CubeDeformation p_170726_) {
        ...
        partdefinition.addOrReplaceChild("head", CubeListBuilder.create()
                .texOffs(0, 0).addBox(-2.0F, -14.0F, -10.0F, 4.0F, 4.0F, 9.0F, p_170726_)
                .texOffs(0, 14).addBox("neck", -4.0F, -16.0F, -6.0F, 8.0F, 18.0F, 6.0F, p_170726_)
                .texOffs(17, 0).addBox("ear", -4.0F, -19.0F, -4.0F, 3.0F, 3.0F, 2.0F, p_170726_)
                .texOffs(17, 0).addBox("ear", 1.0F, -19.0F, -4.0F, 3.0F, 3.0F, 2.0F, p_170726_)
                .texOffs(80, 40).addBox("helmet", -6.0F, -20.0F, -11.0F, 12.0F, 12.0F, 12.0F, p_170726_),
