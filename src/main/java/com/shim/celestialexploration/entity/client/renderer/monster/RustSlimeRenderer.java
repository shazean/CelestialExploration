...
import com.shim.celestialexploration.entity.monster.slimes.RustSlime;
import com.shim.celestialexploration.entity.client.layers.RustSlimeOuterLayer;
...
@OnlyIn(Dist.CLIENT)
public class RustSlimeRenderer extends MobRenderer<RustSlime, SlimeModel<RustSlime>> {
