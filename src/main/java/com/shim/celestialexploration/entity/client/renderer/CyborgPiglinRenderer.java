...
public class CyborgPiglinRenderer extends HumanoidMobRenderer<CyborgPiglin, PiglinModel<CyborgPiglin>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(CelestialExploration.MODID, "textures/entity/piglin/cyborg_piglin.png");
    private static final float PIGLIN_CUSTOM_HEAD_SCALE = 1.0019531F;

    public CyborgPiglinRenderer(EntityRendererProvider.Context context) {
...
//        this.addLayer(new PiglinHelmetLayer<>(this));
    ...
    private static PiglinModel<CyborgPiglin> createModel(EntityModelSet p_174350_, ModelLayerLocation p_174351_, boolean p_174352_) {
        PiglinModel<CyborgPiglin> piglinmodel = new PiglinModel<>(p_174350_.bakeLayer(p_174351_));
        if (p_174352_) {
    ...
    public ResourceLocation getTextureLocation(CyborgPiglin p_115708_) {
        return TEXTURE;
    }
}