...
public class SpaceLlamaDecorLayer extends RenderLayer<SpaceTraderLlama, SpaceLlamaModel<SpaceTraderLlama>> {
    ...
    private final SpaceLlamaModel<SpaceTraderLlama> model;

    public SpaceLlamaDecorLayer(RenderLayerParent<SpaceTraderLlama, SpaceLlamaModel<SpaceTraderLlama>> p_174499_, EntityModelSet p_174500_) {
        super(p_174499_);
        this.model = new SpaceLlamaModel<>(p_174500_.bakeLayer(ModelLayers.LLAMA_DECOR));
    }

    public void render(PoseStack p_117232_, MultiBufferSource p_117233_, int p_117234_, SpaceTraderLlama p_117235_, float p_117236_, float p_117237_, float p_117238_, float p_117239_, float p_117240_, float p_117241_) {
