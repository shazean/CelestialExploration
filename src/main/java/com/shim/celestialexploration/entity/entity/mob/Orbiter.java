...
public class Orbiter extends Ghast implements GeoEntity {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<>(this, "orbiter", 0, event -> event.setAndContinue(animation)));
    }

    protected void registerGoals() {
        this.goalSelector.addGoal(3, new LookAtPlayerGoal(this, Player.class, 15.0F, 1.0F));
        this.goalSelector.addGoal(5, new RandomFloatAroundGoal(this));
        this.goalSelector.addGoal(7, new OrbiterLookGoal(this));
        this.goalSelector.addGoal(7, new OrbiterShootFireballGoal(this));
    ...
    static class OrbiterLookGoal extends Goal {
    ...
    static class OrbiterMoveControl extends MoveControl {
        private final Orbiter ghast;
    ...
    static class OrbiterShootFireballGoal extends Goal {
        private final Orbiter ghast;
