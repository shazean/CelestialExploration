...
public class TameCreatureRandomTargetGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
    private final TamableCreature tamableMob;


    public TameCreatureRandomTargetGoal(TamableCreature p_26097_, Class<T> p_26098_, boolean p_26099_, @Nullable Predicate<LivingEntity> p_26100_) {
