...
public class MagCartFurnace extends AbstractMagCart {
    private static final EntityDataAccessor<Boolean> DATA_ID_FUEL = SynchedEntityData.defineId(MagCartFurnace.class, EntityDataSerializers.BOOLEAN);
    private int fuel;
    public double xPush;
    public double zPush;
    ...
    public MagCartFurnace(Level p_38555_, double p_38556_, double p_38557_, double p_38558_) {
        super(EntityRegistry.FURNACE_MAGCART.get(), p_38555_, p_38556_, p_38557_, p_38558_);
    }

    public MagCartFurnace.Type getMagCartType() {
        return MagCartFurnace.Type.FURNACE;
    }
