...
public class GanymedePortalBlock extends AbstractPortalBlock {
    ...
    public PlanetTeleporter getTeleporter(ServerLevel serverLevel) {
        return new PlanetTeleporter(serverLevel, CelestialPOIs.GANYMEDE_PORTAL.get(), CelestialBlocks.GANYMEDE_BRICKS.get(), CelestialBlocks.GANYMEDE_PORTAL.get(), CelestialDimensions.GANYMEDE);
    }
