...
public class SolarPanelContainer extends AbstractContainerMenu {
    ...
    public SolarPanelContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super(ContainerRegistry.SOLAR_PANEL_CONTAINER.get(), windowId);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(tileEntity.getLevel(), tileEntity.getBlockPos()), playerEntity, BlockRegistry.SOLAR_PANEL.get());
    }
