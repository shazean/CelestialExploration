...
public class ShuttleMenu extends AbstractContainerMenu {
    private final Shuttle entity;
    private final Level level;

    public ShuttleMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
