...
public class AssemblyStationContainer implements Container, StackedContentsCompatible {
    private final NonNullList<ItemStack> items;
    private final int width;
    private final int height;
    private final AbstractContainerMenu menu;

    public AssemblyStationContainer(AbstractContainerMenu p_39325_, int p_39326_, int p_39327_) {
