package mod.shim.celestialexploration.client.model.mobs;
...
public class LurkerModel<T extends Entity> extends SegmentedModel<T> {
	...
	public LurkerModel(float p_i46366_1_) {
		int i = 6;
