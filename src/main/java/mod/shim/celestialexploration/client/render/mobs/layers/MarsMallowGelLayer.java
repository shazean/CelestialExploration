...
public class MarsMallowGelLayer<T extends LivingEntity> extends LayerRenderer<T, MarsMallowModel<T>> {
	   private final EntityModel<T> model = new SlimeModel<>(0);

	   public MarsMallowGelLayer(IEntityRenderer<T, MarsMallowModel<T>> p_i50923_1_) {
	      super(p_i50923_1_);
	   }
