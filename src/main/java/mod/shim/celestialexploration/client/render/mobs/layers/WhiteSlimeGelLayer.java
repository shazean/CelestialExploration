...
@OnlyIn(Dist.CLIENT)
public class WhiteSlimeGelLayer<T extends LivingEntity> extends LayerRenderer<T, WhiteSlimeModel<T>> {
   private final EntityModel<T> model = new SlimeModel<>(0);

   public WhiteSlimeGelLayer(IEntityRenderer<T, WhiteSlimeModel<T>> p_i50923_1_) {
      super(p_i50923_1_);
   }
