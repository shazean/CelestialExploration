...
@OnlyIn(Dist.CLIENT)
public class SulfuricSlimeGelLayer<T extends LivingEntity> extends LayerRenderer<T, SulfuricSlimeModel<T>> {
   private final EntityModel<T> model = new SulfuricSlimeModel<>(0);

   public SulfuricSlimeGelLayer(IEntityRenderer<T, SulfuricSlimeModel<T>> p_i50923_1_) {
      super(p_i50923_1_);
   }
