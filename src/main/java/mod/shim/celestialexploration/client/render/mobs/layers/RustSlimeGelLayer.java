...
@OnlyIn(Dist.CLIENT)
public class RustSlimeGelLayer<T extends LivingEntity> extends LayerRenderer<T, RustSlimeModel<T>> {
   private final EntityModel<T> model = new RustSlimeModel<>(0);

   public RustSlimeGelLayer(IEntityRenderer<T, RustSlimeModel<T>> p_i50923_1_) {
      super(p_i50923_1_);
   }
