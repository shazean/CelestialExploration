...
public class AssemblyStationScreen extends ContainerScreen<AssemblyStationContainer> {

	
	private static final ResourceLocation ASSEMBLY_STATION_GUI = new ResourceLocation(Main.MODID, "textures/gui/assembly_station.png");
	
	public AssemblyStationScreen(AssemblyStationContainer p_i51105_1_, PlayerInventory p_i51105_2_,
	...
	protected void renderBg(MatrixStack p_230450_1_, float p_230450_2_, int mouseX, int mouseY) {
		...
		this.minecraft.textureManager.bind(ASSEMBLY_STATION_GUI);
...
//	public AssemblyStationScreen(WorkbenchContainer p_i51094_1_, PlayerInventory p_i51094_2_,
//			ITextComponent p_i51094_3_) {
