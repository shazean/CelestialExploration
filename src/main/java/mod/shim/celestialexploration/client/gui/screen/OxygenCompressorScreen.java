...
//
//public class OxygenCompressorScreen extends ContainerScreen<OxygenCompressorContainer> {
//
//	
//	private static final ResourceLocation OXYGEN_COMPRESSOR_GUI = new ResourceLocation(Main.MODID, "textures/gui/oxygen_compressor.png");
//	
//	public OxygenCompressorScreen(OxygenCompressorContainer p_i51105_1_, PlayerInventory p_i51105_2_,
...
//		this.minecraft.textureManager.bind(OXYGEN_COMPRESSOR_GUI);
