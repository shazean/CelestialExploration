...
public class RegistryConfiguredStructures {

	/**
     * Static instance of our structure so we can reference it and add it to biomes easily.
     */
    public static StructureFeature<?, ?> CONFIGURED_CRATER = RegistryStructures.CRATER.get().configured(IFeatureConfig.NONE);
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new ResourceLocation(Main.MODID, "configured_crater"), CONFIGURED_CRATER);
        ...
        */
//        FlatGenerationSettings.STRUCTURE_FEATURES.put(RegistryStructures.CRATER.get(), CONFIGURED_CRATER); FIXME
    }
}