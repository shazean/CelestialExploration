...
public class RegistryStructures {
     ...
     */
    public static final RegistryObject<Structure<NoFeatureConfig>> CRATER = DEFERRED_REGISTRY_STRUCTURE.register("crater", () -> (new CraterStructure(NoFeatureConfig.CODEC)));
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(
                CRATER.get(), /* The instance of the structure */
                new StructureSeparationSettings(10 /* average distance apart in chunks between spawn attempts */,
                        ...
                        328974298 /* this modifies the seed of the structure so no two structures always spawn over each-other. Make this large and unique. */),
                true);
