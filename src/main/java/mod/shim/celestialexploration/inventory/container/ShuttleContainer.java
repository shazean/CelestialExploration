...
public class ShuttleContainer extends Container {
	...
	public ShuttleContainer(final int windowId, final PlayerInventory playerInv, final AssemblyStationTileEntity assemblystationte) {
		super(RegistryContainerType.SHUTTLE.get(), windowId);
...
//		}
	...
	public ShuttleContainer(final int windowId, final PlayerInventory playerInv, final PacketBuffer data) {
