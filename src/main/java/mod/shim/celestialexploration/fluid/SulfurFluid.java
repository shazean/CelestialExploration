package mod.shim.celestialexploration.fluid;
...
import mod.shim.celestialexploration.tags.CelestialFluidTags;
...
public abstract class SulfurFluid extends FlowingFluid {
   public Flowing getFlowing() {
      return RegistryFluids.FLOWING_SULFUR.get();
   }
   ...
   public Item getBucket() {
      return RegistryItems.SULFUR_BUCKET.get();
   }
   ...
   public BlockState createLegacyBlock(FluidState p_204527_1_) {
      return RegistryBlocks.SULFUR_BLOCK.get().defaultBlockState().setValue(FlowingFluidBlock.LEVEL, Integer.valueOf(getLegacyLevel(p_204527_1_)));
   }

   public boolean isSame(Fluid p_207187_1_) {
      return p_207187_1_ == RegistryFluids.SULFUR.get() || p_207187_1_ == RegistryFluids.FLOWING_SULFUR.get();
   }
...
//         System.out.println(Main.MODID + ": " + this.is(CelestialFluidTags.SULFUR) + "**********");
//         System.out.println(Main.MODID + ": " + fluidstate.is(FluidTags.WATER) + "**********");
//         if (this.is(CelestialFluidTags.SULFUR) && fluidstate.is(FluidTags.WATER)) {
...
//   }
   ...
   ResourceLocation sulfur = new ResourceLocation("celestialexploration:blocks/sulfur_still");
   ResourceLocation sulfurFlowing = new ResourceLocation("celestialexploration:blocks/sulfur_flow");
   
   @Override
   protected FluidAttributes createAttributes() {
	   return FluidAttributes.builder(sulfur, sulfurFlowing)
			   .translationKey("block.celestialexploration.sulfur")
