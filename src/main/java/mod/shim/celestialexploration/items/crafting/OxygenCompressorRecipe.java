...
public class OxygenCompressorRecipe implements IRecipe<IInventory> {
	   private final Ingredient base;
	   private final Ingredient addition;
	   private final ItemStack result;
	   private final ResourceLocation id;

	   public OxygenCompressorRecipe(ResourceLocation p_i231600_1_, Ingredient p_i231600_2_, Ingredient p_i231600_3_, ItemStack p_i231600_4_) {
	   ...
	   public ItemStack getToastSymbol() {
	      return new ItemStack(RegistryBlocks.OXYGEN_COMPRESSOR.get());
	   }
	   ...
	   public static class Serializer extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<OxygenCompressorRecipe> {
	      public OxygenCompressorRecipe fromJson(ResourceLocation p_199425_1_, JsonObject p_199425_2_) {
	         ...
	         return new OxygenCompressorRecipe(p_199425_1_, ingredient, ingredient1, itemstack);
	      }

	      public OxygenCompressorRecipe fromNetwork(ResourceLocation p_199426_1_, PacketBuffer p_199426_2_) {
	         ...
	         return new OxygenCompressorRecipe(p_199426_1_, ingredient, ingredient1, itemstack);
	      }

	      public void toNetwork(PacketBuffer p_199427_1_, OxygenCompressorRecipe p_199427_2_) {
