package mod.shim.celestialexploration.items.crafting;
...
public class AssemblyStationRecipe implements ICraftingRecipe, net.minecraftforge.common.crafting.IShapedRecipe<CraftingInventory> {
	   ...
	   public AssemblyStationRecipe(ResourceLocation p_i48162_1_, String p_i48162_2_, int p_i48162_3_, int p_i48162_4_, NonNullList<Ingredient> p_i48162_5_, ItemStack p_i48162_6_) {
	      this.id = p_i48162_1_;
...
//	      return IRecipeSerializer.SHAPED_RECIPE;
	   ...
	   public static class Serializer extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>>  implements IRecipeSerializer<AssemblyStationRecipe> {
	      private static final ResourceLocation NAME = new ResourceLocation("celestialexploration", "assembly_station");
	      public AssemblyStationRecipe fromJson(ResourceLocation p_199425_1_, JsonObject p_199425_2_) {
	         String s = JSONUtils.getAsString(p_199425_2_, "group", "");
	         Map<String, Ingredient> map = AssemblyStationRecipe.keyFromJson(JSONUtils.getAsJsonObject(p_199425_2_, "key"));
	         String[] astring = AssemblyStationRecipe.shrink(AssemblyStationRecipe.patternFromJson(JSONUtils.getAsJsonArray(p_199425_2_, "pattern")));
	         int i = astring[0].length();
	         int j = astring.length;
	         NonNullList<Ingredient> nonnulllist = AssemblyStationRecipe.dissolvePattern(astring, map, i, j);
	         ItemStack itemstack = AssemblyStationRecipe.itemFromJson(JSONUtils.getAsJsonObject(p_199425_2_, "result"));
	         return new AssemblyStationRecipe(p_199425_1_, s, i, j, nonnulllist, itemstack);
	      }

	      public AssemblyStationRecipe fromNetwork(ResourceLocation p_199426_1_, PacketBuffer p_199426_2_) {
	         ...
	         return new AssemblyStationRecipe(p_199426_1_, s, i, j, nonnulllist, itemstack);
	      }

	      public void toNetwork(PacketBuffer p_199427_1_, AssemblyStationRecipe p_199427_2_) {
