...
public class SulfuricSlimeEntity extends SlimeEntity {

	public SulfuricSlimeEntity(EntityType<? extends SulfuricSlimeEntity> p_i50202_1_, World p_i50202_2_) {
	...
	public static boolean checkSulfuricSlimeSpawnRules(EntityType<SulfuricSlimeEntity> p_223367_0_, IWorld p_223367_1_, SpawnReason p_223367_2_, BlockPos p_223367_3_, Random p_223367_4_) {
	...
	protected void jumpInLiquid(ITag<Fluid> p_180466_1_) {
		if (p_180466_1_ == FluidTags.LAVA) {
			...
			this.hasImpulse = true;
		} else if (p_180466_1_ == RegistryFluids.SULFUR.get()) {
			Vector3d vector3d = this.getDeltaMovement();
			this.setDeltaMovement(vector3d.x, (double)(0.22F + (float)this.getSize() * 0.05F), vector3d.z);
			this.hasImpulse = true;
