...
public class ShuttleEntity extends Entity {
	   ...
	   private static final DataParameter<Integer> DATA_ID_TYPE = EntityDataManager.defineId(ShuttleEntity.class, DataSerializers.INT);
	   ...
	   private ShuttleEntity.Status oldStatus;
	   private double lastYd;
	   private boolean isAboveBubbleColumn;
	   private boolean bubbleColumnDirectionIsDown;

	   public ShuttleEntity(EntityType<? extends ShuttleEntity> p_i50129_1_, World p_i50129_2_) {
...
//	   public static ShuttleEntity createShuttle(World p_184263_0_, double p_184263_1_, double p_184263_3_, double p_184263_5_) {
//		   System.out.println("ShuttleEntity: createShuttle");
////		      if (p_184263_7_ == AbstractMinecartEntity.Type.CHEST) {
//		         return new ShuttleEntity(p_184263_0_, p_184263_1_, p_184263_3_, p_184263_5_);
...
//		   }
	   ...
	   protected void defineSynchedData() {
	      ...
	      this.entityData.define(DATA_ID_TYPE, ShuttleEntity.Type.OAK.ordinal());
	   }
...
//	   }
	   ...
	   protected void addAdditionalSaveData(CompoundNBT p_213281_1_) {
	      p_213281_1_.putString("Type", this.getShuttleType().getName());
	   }

	   protected void readAdditionalSaveData(CompoundNBT p_70037_1_) {
	      if (p_70037_1_.contains("Type", 8)) {
	         this.setType(ShuttleEntity.Type.byName(p_70037_1_.getString("Type")));
	      }
	   ...
	   public void setType(ShuttleEntity.Type p_184458_1_) {
	      this.entityData.set(DATA_ID_TYPE, p_184458_1_.ordinal());
	   }

	   public ShuttleEntity.Type getShuttleType() {
	      return ShuttleEntity.Type.byId(this.entityData.get(DATA_ID_TYPE));
	   }
...
//	      UNDER_FLOWING_WATER,
	   ...
	   public static enum Type {
	      ...
	      public static ShuttleEntity.Type byId(int p_184979_0_) {
	         ShuttleEntity.Type[] ashuttleentity$type = values();
	         if (p_184979_0_ < 0 || p_184979_0_ >= ashuttleentity$type.length) {
	            p_184979_0_ = 0;
	         }

	         return ashuttleentity$type[p_184979_0_];
	      }

	      public static ShuttleEntity.Type byName(String p_184981_0_) {
	         ShuttleEntity.Type[] ashuttleentity$type = values();

	         for(int i = 0; i < ashuttleentity$type.length; ++i) {
	            if (ashuttleentity$type[i].getName().equals(p_184981_0_)) {
	               return ashuttleentity$type[i];
	            }
	         }

	         return ashuttleentity$type[0];
	      }
	   }

	public Vector3d getPos(double d0, double d1, double d2) {
		// TODO Auto-generated method stub
		return null;
	}

	public Vector3d getPosOffs(double d0, double d1, double d2, double d) {
		// TODO Auto-generated method stub
		return null;
	}
