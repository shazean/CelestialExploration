...
public class MarsFarmlandBlock extends FarmlandBlock {

	public static final IntegerProperty MOISTURE = BlockStateProperties.MOISTURE;
	protected static final VoxelShape SHAPE = Block.box(0.0D, 0.0D, 0.0D, 16.0D, 15.0D, 16.0D);

	public MarsFarmlandBlock(Properties p_i48400_1_) {
		super(p_i48400_1_);
	...
	public BlockState getStateForPlacement(BlockItemUseContext p_196258_1_) {
		return !this.defaultBlockState().canSurvive(p_196258_1_.getLevel(), p_196258_1_.getClickedPos()) ? RegistryBlocks.MARS_SAND.get().defaultBlockState() : super.getStateForPlacement(p_196258_1_);
	}
	...
	public void fallOn(World p_180658_1_, BlockPos p_180658_2_, Entity p_180658_3_, float p_180658_4_) {
		if (!p_180658_1_.isClientSide && net.minecraftforge.common.ForgeHooks.onFarmlandTrample(p_180658_1_, p_180658_2_, RegistryBlocks.MARS_SAND.get().defaultBlockState(), p_180658_4_, p_180658_3_)) { // Forge: Move logic to Entity#canTrample
	...
	public static void turnToDirt(BlockState p_199610_0_, World p_199610_1_, BlockPos p_199610_2_) {
		p_199610_1_.setBlockAndUpdate(p_199610_2_, pushEntitiesUp(p_199610_0_, RegistryBlocks.MARS_SAND.get().defaultBlockState(), p_199610_1_, p_199610_2_));
	}
