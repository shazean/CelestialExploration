...
public class SolarPanelBlock extends Block {
	...
	private static final Map<IBlockReader, List<SolarPanelBlock.Toggle>> RECENT_TOGGLES = new WeakHashMap<>();
	static boolean signalSource;
	public static final IntegerProperty POWER = BlockStateProperties.POWER;
	public static final BooleanProperty INVERTED = BlockStateProperties.INVERTED;


	public SolarPanelBlock(Block.Properties p_i48342_1_) {
	...
	public int getSignal(BlockState p_180656_1_, IBlockReader p_180656_2_, BlockPos p_180656_3_, Direction p_180656_4_) {
		...
		return 15;
	} //change 15 to higher number?
	//might want to change to a straight number like redstone block
	...
	public static void updateSignalStrength(BlockState blockState, World world, BlockPos pos) {
		if (world.dimensionType().hasSkyLight()) {
			int i = world.getBrightness(LightType.SKY, pos) - world.getSkyDarken();
			...
			if (blockState.getValue(POWER) != i) {
				world.setBlock(pos, blockState.setValue(POWER, Integer.valueOf(i)), 3);
			}
	...
	public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
		...
		List<SolarPanelBlock.Toggle> list = RECENT_TOGGLES.get(p_225534_2_);
	...
	//FIXME detect daylight, return true; if night, return false
	...
	private static boolean isToggledTooFrequently(World p_176598_0_, BlockPos p_176598_1_, boolean p_176598_2_) {
		List<SolarPanelBlock.Toggle> list = RECENT_TOGGLES.computeIfAbsent(p_176598_0_, (p_220288_0_) -> {
			return Lists.newArrayList();
		});
		if (p_176598_2_) {
			list.add(new SolarPanelBlock.Toggle(p_176598_1_.immutable(), p_176598_0_.getGameTime()));
		}

		int i = 0;

		for(int j = 0; j < list.size(); ++j) {
			SolarPanelBlock.Toggle solarpanelblock$toggle = list.get(j);
			if (solarpanelblock$toggle.pos.equals(p_176598_1_)) {
				++i;
				if (i >= 8) {
					return true;
				}
