...
//
//public class CraterMeteorStructure extends ScatteredStructure<NoFeatureConfig> {
//	
//	public CraterMeteorStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
//	{
//		super(config);
//	}
//
...
//	{
//		return Main.MODID + ":crater_meteor";
//	}
//
//
//	/*
...
//	{
//		return CraterMeteorStructure.Start::new;
//	}
//
//
//	/*
...
//			CraterMeteorPiece.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
//
//			//Sets the bounds of the structure. 
//			this.recalculateStructureSize();
//
//			//I use to debug and quickly find out if the structure is spawning or not and where it is.
//			Main.LOGGER.log(Level.DEBUG, "Meteor Crater at " + (blockpos.getX()) + " " + blockpos.getY() + " " + (blockpos.getZ()));
//		}
//
//	}
//}