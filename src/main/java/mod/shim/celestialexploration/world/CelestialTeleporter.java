//package mod.shim.celestialexploration.world;
//
...
//
//	public CelestialTeleporter(ServerWorld p_i1963_1_) {
//		super(p_i1963_1_);
...
//		                  BlockState blockstate1 = i3 < 0 ? Blocks.ORANGE_GLAZED_TERRACOTTA.defaultBlockState() : Blocks.AIR.defaultBlockState();
...
//		               this.level.setBlock(blockpos$mutable, Blocks.ORANGE_GLAZED_TERRACOTTA.defaultBlockState(), 3);
//		            }
//		         }
//		      }
//
//		      BlockState blockstate = RegistryBlocks.MARS_PORTAL.get().defaultBlockState().setValue(MarsPortalBlock.AXIS, p_242956_2_);
//
